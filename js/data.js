...
const CARD_POOL = [
  ...
  { id: 'storm_falcon', name: '风暴猎鹰', cost: 5, type: 'minion', attack: 5, hp: 3, rarity: 'legendary', art: '🦅', artImg: 'assets/card-storm-falcon.jpg', text: '冲锋·风怒', charge: true, windfury: true },
  ...
  { id: 'neutral_minion_9', name: '混沌领主', cost: 7, type: 'minion', attack: 8, hp: 7, rarity: 'epic', art: '👹', text: '战吼：对所有敌方随从造成3点伤害', battlecry: 'deal_3_all' },
  { id: 'neutral_minion_10', name: '虚空观察者', cost: 4, type: 'minion', attack: 2, hp: 6, rarity: 'rare', art: '👁️', text: '亡语：抽2张牌', deathrattle: 'draw_2_owner' },
  { id: 'neutral_spell_11', name: '时间扭曲', cost: 5, type: 'spell', rarity: 'epic', art: '⏳', text: '获得2个法力水晶', effect: 'gain_mana_2' },
  ...
  // =============== 检索·牌库机制（7张） ===============
  { id: 'tutor_minion_1', name: '学徒引路', cost: 1, type: 'spell', rarity: 'common', art: '🧭', text: '检索：从牌库抽1张随从牌到手中', effect: 'tutor_minion' },
  { id: 'tutor_spell_1', name: '智慧咏唱', cost: 1, type: 'spell', rarity: 'common', art: '📜', text: '检索：从牌库抽1张法术牌到手中', effect: 'tutor_spell' },
  { id: 'tutor_low_2', name: '战术推演', cost: 2, type: 'spell', rarity: 'rare', art: '🧠', text: '检索：从牌库抽1张费用2点或更低的牌', effect: 'tutor_cost_le2' },
  { id: 'tutor_weapon_2', name: '军备库', cost: 2, type: 'spell', rarity: 'common', art: '⚔️', text: '检索：从牌库抽1张武器牌到手中', effect: 'tutor_weapon' },
  { id: 'tutor_beast_2', name: '兽群呼唤', cost: 2, type: 'spell', rarity: 'rare', art: '🐺', text: '检索：从牌库抽1张野兽牌到手中', effect: 'tutor_race_beast' },
  { id: 'tutor_rare_3', name: '命运启示', cost: 3, type: 'spell', rarity: 'epic', art: '🔮', text: '检索：从牌库抽2张稀有或更高稀有度的牌', effect: 'tutor_rare_plus_2' },
  { id: 'tutor_spell_2', name: '深谋远虑', cost: 3, type: 'spell', rarity: 'epic', art: '📚', text: '检索：从牌库抽2张法术牌到手中', effect: 'tutor_spell_2' },
  ...
  { id: 'mage_flame_walker', name: '火焰行者', cost: 3, type: 'minion', attack: 3, hp: 4, rarity: 'common', art: '🔥', text: '战吼：对所有敌方随从造成3点伤害', battlecry: 'deal_3_all' },
  ...
  { id: 'mage_fireball_2', name: '强化火球', cost: 5, type: 'spell', rarity: 'rare', art: '🔥', text: '造成6点伤害', effect: 'deal_6_face' },
  ...
  { id: 'mage_time_warp', name: '时空穿梭', cost: 7, type: 'spell', rarity: 'legendary', art: '⏳', text: '抽3张牌，并获得1个额外回合', effect: 'time_warp' },
  ...
  { id: 'pal_tirion', name: '提里奥·弗丁', cost: 8, type: 'minion', attack: 6, hp: 6, rarity: 'legendary', art: '👑', text: '嘲讽·圣盾·亡语：召唤一个4/4', taunt: true, divineShield: true, deathrattle: 'summon_4_4' },
  ...
  { id: 'pri_divine', name: '神圣化身', cost: 7, type: 'minion', attack: 7, hp: 7, rarity: 'legendary', art: '👼', text: '圣盾·战吼：恢复6点生命', divineShield: true, battlecry: 'heal_6' },
  ...
  { id: 'war_pit_lord', name: '深渊魔王', cost: 7, type: 'minion', attack: 7, hp: 8, rarity: 'epic', art: '😈', text: '嘲讽·战吼：对所有敌方随从造成3点伤害', taunt: true, battlecry: 'deal_3_all' },
  ...
  { id: 'echo_shield', name: '回响护盾', cost: 1, type: 'spell', rarity: 'rare', art: '🛡️', text: '获得2点护甲（回响：本回合可再次打出）', effect: 'gain_armor_2', echo: true },
  ...
  { id: 'boost_blizzard', name: '增幅暴风雪', cost: 7, type: 'spell', rarity: 'epic', art: '❄️', text: '对所有敌方随从造成3点伤害并冻结。魔力增幅：每使用一张法术，费用-1', effect: 'blizzard', spellboost: 5 },
  ...
  { id: 'shadow_step', name: '暗影步', cost: 1, type: 'spell', rarity: 'epic', art: '🌫️', text: '回响·获得1点法力水晶并抽一张牌', effect: 'gain_mana_draw', echo: true },
  ...
  { id: 'treant_call', name: '召唤树人', cost: 5, type: 'spell', rarity: 'epic', art: '🌲', text: '召唤两个3/2树人', effect: 'summon_two_3_2' },
  ...
  { id: 'totem_army', name: '图腾军团', cost: 5, type: 'spell', rarity: 'epic', art: '🪔', text: '召唤两个2/2嘲讽图腾', effect: 'summon_two_0_2' },
  ...
  { id: 'ro_shiv', name: '毒刃', cost: 1, type: 'spell', rarity: 'common', art: '🔪', text: '造成1点伤害', effect: 'deal_1' },
  { id: 'ro_poison_bite', name: '淬毒撕咬', cost: 2, type: 'spell', rarity: 'common', art: '☠️', text: '造成3点伤害', effect: 'deal_3' },
  { id: 'ro_shadow_strike', name: '影袭', cost: 3, type: 'spell', rarity: 'common', art: '🌑', text: '造成5点伤害', effect: 'deal_5' },
  { id: 'ro_blade_flurry', name: '刀扇乱舞', cost: 3, type: 'spell', rarity: 'rare', art: '🌀', text: '对所有敌方随从造成1点伤害，抽一张牌', effect: 'fan_of_knives' },
  { id: 'ro_ambush', name: '埋伏突袭', cost: 2, type: 'spell', rarity: 'rare', art: '🕶️', text: '召唤一个1/1冲锋小兵', effect: 'summon_1_1_charge' },
  { id: 'ro_sprint_2', name: '疾跑', cost: 4, type: 'spell', rarity: 'epic', art: '🏃', text: '抽三张牌', effect: 'draw_3' },
  { id: 'ro_stealth_ally', name: '暗影帷幕', cost: 2, type: 'spell', rarity: 'rare', art: '🌫️', text: '所有友方随从+1/+1', effect: 'buff_all_1_1' },
  { id: 'ro_assassin', name: '潜行刺客', cost: 3, type: 'minion', attack: 3, hp: 3, rarity: 'common', art: '🗡️', text: '潜行', stealth: true },
  { id: 'ro_poison_master', name: '毒刃大师', cost: 4, type: 'minion', attack: 3, hp: 4, rarity: 'rare', art: '☠️', text: '剧毒：消灭受到其伤害的随从', poisonous: true },
  { id: 'ro_combo_master', name: '连击大师', cost: 5, type: 'minion', attack: 4, hp: 5, rarity: 'epic', art: '⚡', text: '战吼：所有友方随从+2/+2', battlecry: 'buff_all_2_2' },
  { id: 'ro_bounty_hunter', name: '赏金猎人', cost: 3, type: 'minion', attack: 3, hp: 2, rarity: 'common', art: '💰', text: '战吼：抽一张牌', battlecry: 'draw_1' },
  { id: 'ro_shadow_master', name: '暗影宗师', cost: 6, type: 'minion', attack: 5, hp: 5, rarity: 'epic', art: '🌌', text: '战吼：对所有敌方随从造成3点伤害', battlecry: 'deal_3_all' },
  { id: 'ro_poison_knife', name: '淬毒短刃', cost: 2, type: 'weapon', attack: 1, durability: 3, rarity: 'common', art: '🗡️', text: '1/3武器' },
  { id: 'ro_dagger_dancer', name: '刀扇舞者', cost: 4, type: 'minion', attack: 3, hp: 5, rarity: 'rare', art: '💃', text: '风怒：每回合可攻击两次', windfury: true },
  { id: 'ro_cutthroat', name: '冷血杀手', cost: 5, type: 'minion', attack: 4, hp: 4, rarity: 'rare', art: '🔪', text: '潜行·战吼：造成2点伤害', battlecry: 'deal_2', stealth: true },
  { id: 'ro_thief', name: '偷窃者', cost: 2, type: 'minion', attack: 2, hp: 3, rarity: 'common', art: '🕵️', text: '战吼：抽一张牌', battlecry: 'draw_1' },
  { id: 'dr_moonfire_2', name: '月火术', cost: 1, type: 'spell', rarity: 'common', art: '🌙', text: '造成2点伤害', effect: 'deal_2' },
  { id: 'dr_wild_power', name: '野性之力', cost: 3, type: 'spell', rarity: 'rare', art: '🌿', text: '所有野兽随从+2/+2', effect: 'buff_beasts_2_2' },
  { id: 'dr_nature_force', name: '自然之力', cost: 4, type: 'spell', rarity: 'rare', art: '🌳', text: '召唤两个2/2树人', effect: 'summon_two_2_2' },
  { id: 'dr_starfire_2', name: '星火术', cost: 5, type: 'spell', rarity: 'epic', art: '🌟', text: '造成5点伤害', effect: 'deal_5' },
  { id: 'dr_jungle_ward', name: '丛林守护', cost: 3, type: 'spell', rarity: 'common', art: '🌴', text: '获得4点护甲', effect: 'gain_armor_4' },
  { id: 'dr_bark_skin', name: '树皮术', cost: 2, type: 'spell', rarity: 'common', art: '🪵', text: '获得2点护甲', effect: 'gain_armor_2' },
  { id: 'dr_swipe', name: '横扫', cost: 4, type: 'spell', rarity: 'rare', art: '🌪️', text: '对所有敌方随从造成4点伤害', effect: 'deal_4_all' },
  { id: 'dr_vine', name: '藤蔓缠绕', cost: 2, type: 'spell', rarity: 'common', art: '🌿', text: '冻结一个敌方随从', effect: 'freeze_enemy' },
  { id: 'dr_bear_form', name: '巨熊形态', cost: 3, type: 'minion', attack: 4, hp: 4, rarity: 'common', art: '🐻', text: '野兽', race: 'beast' },
  { id: 'dr_guardian_2', name: '森林守护者', cost: 4, type: 'minion', attack: 3, hp: 6, rarity: 'rare', art: '🌲', text: '嘲讽', taunt: true },
  { id: 'dr_apprentice', name: '德鲁伊学徒', cost: 2, type: 'minion', attack: 2, hp: 3, rarity: 'common', art: '🌱', text: '' },
  { id: 'dr_seer', name: '自然先知', cost: 4, type: 'minion', attack: 3, hp: 4, rarity: 'rare', art: '🔮', text: '法术伤害+1', spellDamage: 1 },
  { id: 'dr_ancien', name: '远古树人', cost: 6, type: 'minion', attack: 6, hp: 6, rarity: 'epic', art: '🪵', text: '嘲讽', taunt: true },
  { id: 'dr_elder', name: '橡木长老', cost: 5, type: 'minion', attack: 4, hp: 6, rarity: 'rare', art: '🌳', text: '嘲讽', taunt: true },
  { id: 'dr_wolf_rider', name: '狼骑兵', cost: 3, type: 'minion', attack: 3, hp: 1, rarity: 'common', art: '🐺', text: '冲锋', charge: true },
  { id: 'dr_root', name: '树根缠绕', cost: 1, type: 'spell', rarity: 'common', art: '🌱', text: '造成2点伤害', effect: 'deal_2' },
  { id: 'sa_lightning_2', name: '闪电链', cost: 2, type: 'spell', rarity: 'common', art: '⚡', text: '造成2点伤害', effect: 'deal_2' },
  { id: 'sa_heal_totem', name: '治疗图腾', cost: 2, type: 'spell', rarity: 'common', art: '🩹', text: '恢复4点生命', effect: 'heal_4' },
  { id: 'sa_storm_fury', name: '风暴之怒', cost: 4, type: 'spell', rarity: 'rare', art: '⛈️', text: '对所有敌方随从造成3点伤害', effect: 'deal_3_all' },
  { id: 'sa_totem_boost', name: '图腾之力', cost: 2, type: 'spell', rarity: 'common', art: '🪔', text: '所有友方随从+1/+1', effect: 'buff_all_1_1' },
  { id: 'sa_elem_blast', name: '元素冲击', cost: 3, type: 'spell', rarity: 'rare', art: '🔥', text: '造成4点伤害', effect: 'deal_4' },
  { id: 'sa_wild_strike', name: '野性打击', cost: 3, type: 'spell', rarity: 'common', art: '🌩️', text: '造成5点伤害', effect: 'deal_5' },
  { id: 'sa_totem_army_2', name: '图腾军团', cost: 5, type: 'spell', rarity: 'epic', art: '🪔', text: '召唤两个2/2嘲讽图腾', effect: 'summon_two_0_2' },
  { id: 'sa_chain_lightning', name: '连锁闪电', cost: 3, type: 'spell', rarity: 'rare', art: '⚡', text: '造成3点伤害，抽一张牌', effect: 'deal_3_draw_1' },
  { id: 'sa_frost_shock_2', name: '冰霜震击', cost: 1, type: 'spell', rarity: 'common', art: '❄️', text: '冻结一个敌方随从', effect: 'freeze_enemy' },
  { id: 'sa_fire_elemental', name: '火焰元素使', cost: 5, type: 'minion', attack: 5, hp: 5, rarity: 'common', art: '🔥', text: '元素' },
  { id: 'sa_tide_priest', name: '潮汐祭司', cost: 4, type: 'minion', attack: 3, hp: 5, rarity: 'rare', art: '🌊', text: '战吼：恢复4点生命', battlecry: 'heal_4' },
  { id: 'sa_thunder_herald', name: '雷霆使者', cost: 5, type: 'minion', attack: 5, hp: 5, rarity: 'epic', art: '⛈️', text: '战吼：对所有敌方随从造成2点伤害', battlecry: 'deal_2_all' },
  { id: 'sa_wind_totem', name: '风怒图腾', cost: 3, type: 'minion', attack: 0, hp: 3, rarity: 'common', art: '💨', text: '法术伤害+1', spellDamage: 1 },
  ...
  // ===== 第12轮：牧师体系扩充（+6） =====
  { id: 'pri_shadow_pain', name: '暗言术：痛', cost: 2, type: 'spell', rarity: 'common', art: '💜', text: '造成3点伤害', effect: 'deal_3' },
  { id: 'pri_holy_shield', name: '神圣护盾', cost: 2, type: 'spell', rarity: 'common', art: '🛡️', text: '获得4点护甲', effect: 'gain_armor_4' },
  { id: 'pri_spirit_priest', name: '灵魂祭司', cost: 3, type: 'minion', attack: 3, hp: 4, rarity: 'common', art: '👻', text: '战吼：恢复4点生命', battlecry: 'heal_4' },
  { id: 'pri_mind_spike', name: '心灵尖刺', cost: 3, type: 'spell', rarity: 'rare', art: '🗡️', text: '造成5点伤害', effect: 'deal_5' },
  { id: 'pri_holy_champion', name: '圣光勇士', cost: 5, type: 'minion', attack: 4, hp: 5, rarity: 'rare', art: '⚔️', text: '战吼：所有随从获得+1/+1', battlecry: 'buff_all_1_1' },
  { id: 'pri_shadow_madness', name: '暗影狂乱', cost: 5, type: 'spell', rarity: 'epic', art: '🌑', text: '控制一个敌方随从', effect: 'mind_control' },
  // ===== 第12轮：德鲁伊体系扩充（+6） =====
  { id: 'dru_growth', name: '成长', cost: 2, type: 'spell', rarity: 'common', art: '🌱', text: '获得3点护甲', effect: 'gain_armor_3' },
  { id: 'dru_savage_roar', name: '野蛮咆哮', cost: 3, type: 'spell', rarity: 'rare', art: '🦁', text: '所有随从获得+2/+2', effect: 'buff_all_2_2' },
  { id: 'dru_swift', name: '迅捷德鲁伊', cost: 3, type: 'minion', attack: 3, hp: 3, rarity: 'common', art: '🐆', text: '冲锋', charge: true },
  { id: 'dru_force_nature', name: '自然之力', cost: 4, type: 'spell', rarity: 'rare', art: '🌳', text: '召唤两个3/3树人', effect: 'summon_two_3_3' },
  { id: 'dru_ancient_guardian', name: '远古守护者', cost: 5, type: 'minion', attack: 4, hp: 6, rarity: 'rare', art: '🌲', text: '嘲讽', taunt: true, race: 'beast' },
  { id: 'dru_cenarius', name: '塞纳留斯', cost: 7, type: 'minion', attack: 5, hp: 5, rarity: 'legendary', art: '🍃', text: '战吼：所有随从获得+1/+1', battlecry: 'buff_all_1_1' },
  // ===== 第12轮：战士体系扩充（+4） =====
  { id: 'war_shield_block', name: '盾牌格挡', cost: 2, type: 'spell', rarity: 'common', art: '🛡️', text: '获得4点护甲', effect: 'gain_armor_4' },
  { id: 'war_battle_rage', name: '战斗怒火', cost: 3, type: 'spell', rarity: 'common', art: '😤', text: '抽2张牌', effect: 'draw_2' },
  { id: 'war_frothing', name: '狂战士', cost: 4, type: 'minion', attack: 3, hp: 4, rarity: 'rare', art: '🪓', text: '激怒：攻击力+2', enrage: 2 },
  { id: 'war_grommash', name: '格罗玛什', cost: 6, type: 'minion', attack: 5, hp: 5, rarity: 'epic', art: '⚔️', text: '冲锋', charge: true },
  // ===== 第12轮：萨满体系扩充（+4） =====
  { id: 'sha_rockbiter', name: '石化武器', cost: 1, type: 'spell', rarity: 'common', art: '🪨', text: '造成2点伤害', effect: 'deal_2' },
  { id: 'sha_healing_rain', name: '治疗之雨', cost: 3, type: 'spell', rarity: 'common', art: '🌧️', text: '恢复4点生命', effect: 'heal_4' },
  { id: 'sha_totem_carver', name: '图腾雕刻者', cost: 3, type: 'minion', attack: 2, hp: 4, rarity: 'rare', art: '🗿', text: '战吼：召唤一个1/1冲锋图腾', battlecry: 'summon_1_1_charge' },
  { id: 'sha_elem_destruction', name: '元素毁灭', cost: 5, type: 'spell', rarity: 'epic', art: '⚡', text: '对所有敌方随从造成4点伤害', effect: 'deal_4_all' },
  // ===== 第12轮：法师+2 =====
  { id: 'mag_frost_nova', name: '冰霜新星', cost: 3, type: 'spell', rarity: 'rare', art: '❄️', text: '冻结所有敌方随从', effect: 'freeze_all' },
  { id: 'mag_arcane_blast', name: '奥术冲击', cost: 4, type: 'spell', rarity: 'rare', art: '💫', text: '造成5点伤害，抽1张牌', effect: 'deal_5_draw_1' },
  // ===== 第12轮：猎人+2 =====
  { id: 'hun_deadly_shot', name: '致命射击', cost: 3, type: 'spell', rarity: 'rare', art: '🎯', text: '消灭一个敌方随从', effect: 'assassinate' },
  { id: 'hun_savannah', name: '长鬃草原狮', cost: 6, type: 'minion', attack: 5, hp: 5, rarity: 'epic', art: '🦁', text: '嘲讽', taunt: true, race: 'beast' },
  // ===== 第12轮：圣骑+2 =====
  { id: 'pal_consecrate', name: '奉献', cost: 4, type: 'spell', rarity: 'common', art: '✨', text: '对所有敌方随从造成3点伤害', effect: 'deal_3_all' },
  { id: 'pal_tirion', name: '提里奥·弗丁', cost: 8, type: 'minion', attack: 6, hp: 6, rarity: 'legendary', art: '🛡️', text: '圣盾·嘲讽·战吼：恢复6点生命', divineShield: true, taunt: true, battlecry: 'heal_6' },
  // ===== 第12轮：术士+2 =====
  { id: 'war_shadow_bolt', name: '暗影箭', cost: 2, type: 'spell', rarity: 'common', art: '🏹', text: '造成4点伤害', effect: 'deal_4' },
  { id: 'war_voidcaller', name: '虚空召唤者', cost: 4, type: 'minion', attack: 3, hp: 4, rarity: 'rare', art: '🌀', text: '战吼：召唤一个2/2虚空行者', battlecry: 'summon_2_2', race: 'demon' },
  // ===== 第12轮：盗贼+2 =====
  { id: 'ro_backstab', name: '背刺', cost: 1, type: 'spell', rarity: 'common', art: '🗡️', text: '造成2点伤害', effect: 'deal_2' },
  { id: 'ro_sap', name: '闷棍', cost: 3, type: 'spell', rarity: 'common', art: '💫', text: '冻结一个敌方随从', effect: 'freeze_enemy' },
  // ===== 第12轮：中立+2 =====
  ...
  { id: 'mage_epic_manaflood', name: '奥术洪流', cost: 4, type: 'spell', rarity: 'epic', art: '🌀', text: '抽3张牌', effect: 'draw_3' },
  { id: 'mage_epic_meteor', name: '陨石术', cost: 6, type: 'spell', rarity: 'epic', art: '☄️', text: '对所有敌人造成4点伤害', effect: 'deal_4_all' },
  { id: 'war_epic_bastion', name: '堡垒壁垒', cost: 3, type: 'spell', rarity: 'epic', art: '🛡️', text: '获得8点护甲', effect: 'gain_armor_8' },
  { id: 'war_epic_execution', name: '处决', cost: 4, type: 'spell', rarity: 'epic', art: '⚔️', text: '造成6点伤害', effect: 'deal_6_face' },
  { id: 'ro_epic_toxic', name: '剧毒爆发', cost: 3, type: 'spell', rarity: 'epic', art: '☠️', text: '使敌人中毒5层', effect: 'poison_face_5' },
  { id: 'ro_epic_shadowy', name: '幽影突袭', cost: 2, type: 'spell', rarity: 'epic', art: '🌑', text: '造成5点伤害，抽1张牌', effect: 'deal_5_draw_1' },
  { id: 'dru_epic_wildswarm', name: '自然大军', cost: 5, type: 'spell', rarity: 'epic', art: '🌿', text: '召唤两个3/3野兽', effect: 'summon_two_3_3' },
  { id: 'dru_epic_savage', name: '野蛮咆哮', cost: 3, type: 'spell', rarity: 'epic', art: '🐺', text: '所有随从+2/+2', effect: 'buff_all_2_2' },
  { id: 'pal_epic_light', name: '神圣之光', cost: 2, type: 'spell', rarity: 'epic', art: '✨', text: '恢复8点生命', effect: 'heal_8' },
  { id: 'pal_epic_crusade', name: '圣战', cost: 5, type: 'spell', rarity: 'epic', art: '⚜️', text: '所有随从+3/+3', effect: 'buff_all_3_3' },
  { id: 'epic_twilight_dragon', name: '暮光巨龙', cost: 5, type: 'minion', attack: 4, hp: 7, rarity: 'legendary', art: '🐉', text: '法术伤害+1', spellDamage: 1 },
  { id: 'epic_void_giant', name: '虚空巨像', cost: 7, type: 'minion', attack: 6, hp: 8, rarity: 'legendary', art: '🗿', text: '嘲讽', taunt: true },
];
...
const ACTIVE_TREASURES = [
  ...
  { id: 'treasure_dragon', name: '巨龙之魂', cost: 5, type: 'minion', attack: 7, hp: 7, rarity: 'legendary', art: '🐉', text: '龙·嘲讽', race: 'dragon', taunt: true },
  { id: 'treasure_hourglass', name: '时光沙漏', cost: 2, type: 'spell', rarity: 'legendary', art: '⏳', text: '抽三张牌（回响：本回合可再次打出）', effect: 'draw_3', echo: true },
  { id: 'treasure_vortex', name: '虚空漩涡', cost: 4, type: 'spell', rarity: 'legendary', art: '🌀', text: '对所有敌人造成4点伤害', effect: 'deal_4_all' },
  { id: 'treasure_blessing', name: '神圣庇护', cost: 3, type: 'spell', rarity: 'legendary', art: '😇', text: '所有友方随从+3/+3', effect: 'buff_all_3_3' },
  { id: 'treasure_power', name: '力量图腾', cost: 2, type: 'spell', rarity: 'legendary', art: '🪨', text: '获得8点护甲', effect: 'gain_armor_8' },
  { id: 'treasure_phoenix', name: '涅槃凤凰', cost: 4, type: 'minion', attack: 4, hp: 4, rarity: 'legendary', art: '🔥', text: '复生（以4点生命复活）·战吼：恢复4点生命', battlecry: 'heal_4', rebirth: true, rebirthHp: 4 },
  { id: 'treasure_storm', name: '风暴之眼', cost: 3, type: 'spell', rarity: 'legendary', art: '🌪️', text: '对所有敌方随从造成3点伤害，抽一张牌', effect: 'deal_3_draw_1' },
  { id: 'treasure_titan', name: '泰坦之拳', cost: 6, type: 'minion', attack: 8, hp: 8, rarity: 'legendary', art: '👊', text: '嘲讽', taunt: true },
];
...
const RELICS = [
  ...
  { id: 'lifesteal', name: '吸血獠牙', icon: '🩸', desc: '你的随从造成伤害时，恢复一半伤害值的生命', effect: 'lifesteal' },
  { id: 'echo_relic', name: '回响之笛', icon: '🎶', desc: '每回合第一张法术牌打出后回到手牌', effect: 'echo_relic' },
  ...
  { id: 'evolve_boost', name: '进化之心', icon: '✨', desc: '每场战斗进化次数+1', effect: 'evolve_boost' },
  { id: 'spell_power_3', name: '奥秘之源', icon: '🔮', desc: '法术伤害+3', effect: 'spell_power_3' },
  { id: 'extra_draw_3', name: '命运卷轴', icon: '📜', desc: '每场战斗开始多抽3张牌', effect: 'extra_draw_3' },
  { id: 'regen_3', name: '生命之环', icon: '🟢', desc: '每回合结束恢复3点生命', effect: 'regen_3' },
  { id: 'thorns_3', name: '荆棘圣域', icon: '🌵', desc: '受到伤害时对攻击者造成3点伤害', effect: 'thorns_3' },
  { id: 'fire_aura_3', name: '末日之焰', icon: '🔥', desc: '回合结束时对敌方造成4点伤害', effect: 'fire_aura_3' },
  { id: 'hero_power_free', name: '战神之怒', icon: '⚔️', desc: '英雄技能费用为0', effect: 'hero_power_free' },
  ...
  { id: 'wisdom_scroll', name: '智慧卷轴', icon: '📜', desc: '每回合开始额外抽1张牌', effect: 'extra_draw' },
  { id: 'greedy_heart', name: '贪婪之心', icon: '💰', desc: '每场战斗胜利额外获得20金币', effect: 'extra_gold' },
...
const META_UPGRADES = [
  { id: 'max_hp', name: '生命强化', icon: '❤️', desc: '每级初始最大生命值+4', maxLevel: 25, costs: [3,6,9,12,15,18,21,24,27,30,33,36,39,42,45,48,51,54,57,60,63,66,69,72,75] },
