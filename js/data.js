...
const ENEMIES = {
  normal: [
    { name: '森林哥布林', portrait: '👺', hp: 28, deck: ['murloc','wolf','orc_grunt','berserker','war_hammer','lightning_bolt','healer','stone_golem','blood_imp','ogre'], ai: 'aggressive', personality: 'swarm' },
    { name: '亡灵术士', portrait: '💀', hp: 30, deck: ['blood_imp','summoner','cultist','mirror_entity','undead_knight','assassinate','card_drawer','berserker','shield_bearer','wolf'], ai: 'control', personality: 'vampiric' },
    { name: '兽人战狂', portrait: '👹', hp: 32, deck: ['orc_grunt','berserker','war_hammer','ogre','war_golem','wolf','guardsman','flame_sword','shield_bearer','fireball'], ai: 'aggressive', personality: 'frenzy' },
    { name: '暗影法师', portrait: '🧙', hp: 26, deck: ['arcane_missiles','lightning_bolt','arcane_intellect','fireball','consecration','flamestrike','spellblade','freeze_elem','polymorph','card_drawer'], ai: 'spell', personality: 'reflect' },
    { name: '鱼人领袖', portrait: '🐟', hp: 28, deck: ['murloc','murloc','wolf','archer','fan_of_knives','berserker','healer','charge_knight','lightning_bolt','ogre'], ai: 'aggressive', personality: 'commander' },
    { name: '黑骑士', portrait: '🛡️', hp: 30, deck: ['guardsman','stone_golem','shield_bearer','paladin_knight','war_hammer','flame_sword','healer','doom_blade','ogre','cultist'], ai: 'control', personality: 'guardian' },
    { name: '治疗德鲁伊', portrait: '🌿', hp: 30, deck: ['healer','holy_light','circle_healing','guardian_of_kings','stone_golem','guardsman','armored_knight','shield_bearer','holy_nova','soul_purify'], ai: 'control', personality: 'guardian' },
    { name: '武器战狂', portrait: '⚔️', hp: 28, deck: ['war_hammer','flame_sword','battle_axe','rusty_knife','orc_grunt','berserker','wolf','frostwolf_grunt','guardsman','lightning_bolt'], ai: 'aggressive', personality: 'frenzy' },
    { name: '鱼人潮行者', portrait: '🐟', hp: 26, deck: ['murloc','murloc','scout','blood_imp','wolf','archer','charge_knight','tundra_rhino','fan_of_knives','lightning_bolt'], ai: 'aggressive', personality: 'swarm' },
    { name: '冰霜法师', portrait: '❄️', hp: 28, deck: ['freeze_elem','water_elemental','blizzard','polymorph','arcane_missiles','fireball','arcane_intellect','spellblade','mana_wraith','card_drawer'], ai: 'spell', personality: 'reflect' },
    { name: '亡语牧师', portrait: '💀', hp: 32, deck: ['blood_imp','summoner','cultist','undead_knight','loot_hoarder','sylvanas','mirror_entity','shield_bearer','assassinate','circle_healing'], ai: 'control', personality: 'vampiric' },
    { name: '快攻猎人', portrait: '🏹', hp: 26, deck: ['wolf','murloc','tundra_rhino','charge_knight','blood_imp','berserker','windfury_harpy','storm_falcon','lightning_bolt','rusty_knife'], ai: 'aggressive', personality: 'commander' },
  ],
  elite: [
    { name: '石拳巨魔', portrait: '🧌', hp: 40, deck: ['ogre','war_golem','berserker','war_hammer','doom_blade','shield_bearer','stone_golem','giant','undead_knight','fireball'], ai: 'aggressive', personality: 'frenzy' },
    { name: '龙裔术士', portrait: '🐲', hp: 38, deck: ['dragon','pyroblast','flamestrike','mind_control','spellblade','freeze_elem','arcane_intellect','equality','water_elemental','fireball'], ai: 'spell', personality: 'reflect' },
    { name: '死亡领主', portrait: '⚰️', hp: 42, deck: ['undead_knight','sylvanas','cultist','summoner','mirror_entity','assassinate','mind_control','shield_bearer','deathwing','loot_hoarder'], ai: 'control', personality: 'vampiric' },
    { name: '风暴召唤者', portrait: '⛈️', hp: 36, deck: ['freeze_elem','lightning_storm','blizzard','water_elemental','arcane_missiles','lightning_bolt','spellblade','flamestrike','consecration','card_drawer'], ai: 'spell', personality: 'guardian' },
    { name: '火焰领主', portrait: '🔥', hp: 44, deck: ['fireball','flamestrike','pyroblast','arcane_missiles','lightning_bolt','spellblade','mana_wraith','archmage','water_elemental','blizzard'], ai: 'spell', personality: 'frenzy' },
    { name: '钢铁守卫', portrait: '🛡️', hp: 48, deck: ['shield_bearer','stone_golem','guardsman','armored_knight','guardian_king','iron_bastion','war_golem','ancient_warrior','ogre','boulderfist_ogre'], ai: 'control', personality: 'guardian' },
    { name: '虚空恐魔', portrait: '👹', hp: 42, deck: ['blood_imp','cultist','undead_knight','death_stalker','sylvanas','deathwing','mind_control','berserker','ogre','doom_blade'], ai: 'aggressive', personality: 'vampiric' },
  ],
  boss: [
