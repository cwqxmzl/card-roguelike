...
const CARD_POOL = [
  // --- Commons ---
  { id: 'wisp', name: '小精灵', cost: 1, type: 'minion', attack: 1, hp: 1, art: '🧚', text: '' , rarity: 'common'},
  { id: 'vampire_bat', name: '吸血蝙蝠', cost: 1, type: 'minion', attack: 1, hp: 2, art: '🦇', text: '吸血', lifesteal: true , rarity: 'common'},
  { id: 'guardsman', name: '侍从卫兵', cost: 1, type: 'minion', attack: 1, hp: 2, art: '🛡️', text: '嘲讽', taunt: true , rarity: 'common'},
  { id: 'stone_golem', name: '石像鬼', cost: 2, type: 'minion', attack: 1, hp: 4, art: '🗿', text: '嘲讽', taunt: true , rarity: 'common'},
  { id: 'blood_imp', name: '血色小鬼', cost: 1, type: 'minion', attack: 2, hp: 1, art: '😈', text: '亡语：对敌方英雄造成1点伤害', deathrattle: 'deal_face_1' , rarity: 'common'},
  { id: 'murloc', name: '鱼人战士', cost: 2, type: 'minion', attack: 2, hp: 2, art: '🐟', text: '', race: 'beast' , rarity: 'common'},
  { id: 'poison_snake', name: '剧毒蛇', cost: 2, type: 'minion', attack: 2, hp: 1, art: '🐍', text: '剧毒', poisonous: true, race: 'beast' , rarity: 'common'},
  { id: 'archer', name: '精灵弓手', cost: 2, type: 'minion', attack: 2, hp: 2, art: '🏹', text: '战吼：造成1点伤害', battlecry: 'deal_1' , rarity: 'common'},
  { id: 'healer', name: '圣光侍僧', cost: 2, type: 'minion', attack: 1, hp: 3, art: '✝️', text: '战吼：恢复3点生命', battlecry: 'heal_3' , rarity: 'common'},
  { id: 'wolf', name: '森林狼', cost: 2, type: 'minion', attack: 3, hp: 2, art: '🐺', text: '', race: 'beast' , rarity: 'common'},
  { id: 'shield_bearer', name: '持盾者', cost: 3, type: 'minion', attack: 0, hp: 6, art: '🛡️', text: '嘲讽', taunt: true , rarity: 'common'},
  { id: 'orc_grunt', name: '兽人步兵', cost: 3, type: 'minion', attack: 3, hp: 3, art: '👹', text: '' , rarity: 'common'},
  { id: 'card_drawer', name: '秘法师', cost: 3, type: 'minion', attack: 2, hp: 2, art: '📜', text: '战吼：抽一张牌', battlecry: 'draw_1' , rarity: 'common'},
  { id: 'berserker', name: '狂战士', cost: 3, type: 'minion', attack: 4, hp: 2, art: '🪓', text: '' , rarity: 'common'},
  { id: 'freeze_elem', name: '冰霜元素', cost: 4, type: 'minion', attack: 3, hp: 5, art: '❄️', text: '战吼：冻结一个敌方随从', battlecry: 'freeze_enemy' , rarity: 'common'},
  { id: 'ogre', name: '食人魔', cost: 4, type: 'minion', attack: 4, hp: 4, art: '👺', text: '' , rarity: 'common'},
  { id: 'paladin_knight', name: '圣骑士', cost: 4, type: 'minion', attack: 3, hp: 4, art: '⚔️', text: '圣盾', divineShield: true , rarity: 'common'},
  { id: 'summoner', name: '召唤师', cost: 4, type: 'minion', attack: 2, hp: 3, art: '🔮', text: '亡语：召唤一个2/2随从', deathrattle: 'summon_2_2' , rarity: 'common'},
  { id: 'war_golem', name: '战争魔像', cost: 7, type: 'minion', attack: 7, hp: 7, art: '🗿', text: '' , rarity: 'common'},
  // Spells - Common
  { id: 'arcane_missiles', name: '奥术飞弹', cost: 2, type: 'spell', art: '✨', text: '随机对敌人造成3点伤害', effect: 'arcane_missiles' , rarity: 'common'},
  { id: 'holy_light', name: '圣光术', cost: 2, type: 'spell', art: '🌟', text: '恢复5点生命', effect: 'heal_5' , rarity: 'common'},
  { id: 'lightning_bolt', name: '闪电箭', cost: 2, type: 'spell', art: '⚡', text: '造成3点伤害', effect: 'deal_3_face' , rarity: 'common'},
  { id: 'arcane_intellect', name: '奥术智慧', cost: 3, type: 'spell', art: '📖', text: '抽两张牌', effect: 'draw_2' , rarity: 'common'},
  { id: 'fan_of_knives', name: '刀扇', cost: 3, type: 'spell', art: '🔪', text: '对所有敌方随从造成1点伤害，抽一张牌', effect: 'fan_of_knives' , rarity: 'common'},
  { id: 'fireball', name: '火球术', cost: 4, type: 'spell', art: '🔥', text: '造成6点伤害', effect: 'deal_6_face' , rarity: 'common'},
  { id: 'consecration', name: '奉献', cost: 4, type: 'spell', art: '☀️', text: '对所有敌方随从造成2点伤害', effect: 'consecration' , rarity: 'common'},
  { id: 'polymorph', name: '变形术', cost: 4, type: 'spell', art: '🐑', text: '将一个随从变为1/1', effect: 'polymorph' , rarity: 'common'},
  { id: 'blizzard', name: '暴风雪', cost: 6, type: 'spell', art: '🌨️', text: '对所有敌方随从造成2点伤害并冻结', effect: 'blizzard' , rarity: 'common'},
  // Weapons
  { id: 'rusty_knife', name: '锈刃', cost: 1, type: 'weapon', attack: 1, durability: 3, art: '🗡️', text: '' , rarity: 'common'},
  { id: 'war_hammer', name: '战锤', cost: 3, type: 'weapon', attack: 3, durability: 2, art: '🔨', text: '' , rarity: 'common'},
  { id: 'flame_sword', name: '烈焰之剑', cost: 4, type: 'weapon', attack: 3, durability: 2, art: '⚔️', text: '战吼：造成1点伤害', battlecry: 'deal_1_face' , rarity: 'common'},
  // --- Rares ---
  { id: 'charge_knight', name: '冲锋骑士', cost: 3, type: 'minion', attack: 3, hp: 2, art: '🐴', text: '冲锋', charge: true , rarity: 'rare'},
  { id: 'windfury_harpy', name: '风怒鹰身人', cost: 4, type: 'minion', attack: 3, hp: 4, art: '🦅', text: '风怒（可攻击两次）', windfury: true , rarity: 'rare'},
  { id: 'cultist', name: '邪教徒', cost: 3, type: 'minion', attack: 2, hp: 2, art: '🪬', text: '亡语：使一个友方随从+2/+2', deathrattle: 'buff_friendly_2_2' , rarity: 'rare'},
  { id: 'spellblade', name: '法术之刃', cost: 2, type: 'minion', attack: 1, hp: 3, art: '🌀', text: '法术伤害+1', spellDamage: 1 , rarity: 'rare'},
  { id: 'overload_lightning', name: '超载闪电', cost: 2, type: 'spell', art: '⚡', text: '造成3点伤害，过载1', effect: 'deal_3_face', overload: 1 , rarity: 'rare'},
  { id: 'overload_missiles', name: '过载飞弹', cost: 1, type: 'spell', art: '✨', text: '随机对敌人造成3点伤害，过载1', effect: 'arcane_missiles', overload: 1 , rarity: 'rare'},
  { id: 'overload_wolf', name: '过载狼骑', cost: 3, type: 'minion', attack: 4, hp: 3, art: '🐺', text: '过载1', overload: 1, race: 'beast' , rarity: 'rare'},
  { id: 'vampire_lord', name: '吸血鬼领主', cost: 3, type: 'minion', attack: 3, hp: 3, art: '🧛', text: '吸血', lifesteal: true , rarity: 'rare'},
  { id: 'mirror_entity', name: '镜像实体', cost: 1, type: 'minion', attack: 0, hp: 2, art: '🪞', text: '嘲讽·亡语：召唤一个0/2嘲讽', taunt: true, deathrattle: 'summon_0_2_taunt' , rarity: 'rare'},
  { id: 'plague_toad', name: '瘟疫蟾蜍', cost: 3, type: 'minion', attack: 2, hp: 3, art: '🐸', text: '剧毒', poisonous: true, race: 'beast' , rarity: 'rare'},
  // Rare Spells
  { id: 'flamestrike', name: '烈焰风暴', cost: 5, type: 'spell', art: '🌋', text: '对所有敌方随从造成4点伤害', effect: 'flamestrike' , rarity: 'rare'},
  { id: 'assassinate', name: '刺杀', cost: 5, type: 'spell', art: '🗡️', text: '消灭一个敌方随从', effect: 'assassinate' , rarity: 'rare'},
  { id: 'circle_healing', name: '群体治疗', cost: 4, type: 'spell', art: '💫', text: '恢复所有友方随从2点生命，英雄恢复4点', effect: 'mass_heal' , rarity: 'rare'},
  { id: 'lightning_storm', name: '闪电风暴', cost: 4, type: 'spell', art: '⛈️', text: '对所有敌方随从造成3点伤害', effect: 'deal_3_all' , rarity: 'rare'},
  // Rare Weapons
  { id: 'doom_blade', name: '末日之刃', cost: 5, type: 'weapon', attack: 5, durability: 2, art: '🌑', text: '亡语：对敌方英雄造成3点伤害' , rarity: 'rare'},
  // --- Epics ---
  ...
  // Epic Spells
  { id: 'pyroblast', name: '炎爆术', cost: 8, type: 'spell', art: '☄️', text: '造成10点伤害', effect: 'deal_10_face' , rarity: 'epic'},
  { id: 'mind_control', name: '精神控制', cost: 6, type: 'spell', art: '🧠', text: '获得一个敌方随从的控制权', effect: 'mind_control' , rarity: 'epic'},
  { id: 'equality', name: '生而平等', cost: 3, type: 'spell', art: '⚖️', text: '将所有随从的生命值变为1', effect: 'equality' , rarity: 'epic'},
  // --- Legendaries ---
  ...
  { id: 'iron_bastion', name: '钢铁堡垒', cost: 6, type: 'minion', attack: 6, hp: 8, art: '🏰', artImg: 'assets/card-iron-bastion.jpg', text: '嘲讽·战吼：获得5点护甲', taunt: true, battlecry: 'gain_armor_5' , rarity: 'legendary'},
  { id: 'storm_falcon', name: '风暴猎鹰', cost: 5, type: 'minion', attack: 5, hp: 3, art: '🦅', artImg: 'assets/card-storm-falcon.jpg', text: '冲锋·风怒', charge: true, windfury: true , rarity: 'legendary'},
  { id: 'lightbringer', name: '光明使者', cost: 7, type: 'minion', attack: 7, hp: 7, art: '🕊️', text: '战吼：使所有友方随从+2/+2', battlecry: 'buff_all_2_2' , rarity: 'legendary'},
  // --- Priest ---
  { id: 'holy_smite', name: '圣光惩击', cost: 2, type: 'spell', art: '✨', text: '对任意目标造成3点伤害', effect: 'smite' , rarity: 'common'},
  { id: 'power_word_shield', name: '真言术·盾', cost: 1, type: 'spell', art: '🛡️', text: '使一个友方随从+2/+2，抽一张牌', effect: 'pw_shield' , rarity: 'common'},
  { id: 'northshire', name: '北郡牧师', cost: 1, type: 'minion', attack: 1, hp: 2, art: '⛪', text: '战吼：抽一张牌', battlecry: 'draw_1' , rarity: 'common'},
  { id: 'soul_purify', name: '灵魂净化', cost: 3, type: 'spell', art: '🌑', text: '对所有敌方随从造成2点伤害', effect: 'consecration' , rarity: 'common'},
  { id: 'holy_nova', name: '神圣新星', cost: 4, type: 'spell', art: '🌟', text: '对所有敌人造成2点伤害，恢复所有友方角色2点生命', effect: 'holy_nova' , rarity: 'common'},
  { id: 'holy_fire', name: '神圣之火', cost: 5, type: 'spell', art: '🔥', text: '对任意目标造成5点伤害，恢复你5点生命', effect: 'holy_fire' , rarity: 'common'},
  { id: 'light_pope', name: '光明大祭司', cost: 7, type: 'minion', attack: 7, hp: 8, art: '🕯️', text: '战吼：恢复6点生命', battlecry: 'heal_6' , rarity: 'common'},
  // --- New Cards (Balance Expansion) ---
  { id: 'scout', name: '斥候', cost: 1, type: 'minion', attack: 1, hp: 1, art: '🔭', text: '战吼：抽一张牌', battlecry: 'draw_1' , rarity: 'common'},
  { id: 'torch_bearer', name: '持炬者', cost: 2, type: 'minion', attack: 2, hp: 3, art: '🔥', text: '战吼：造成1点伤害', battlecry: 'deal_1' , rarity: 'common'},
  { id: 'voodoo_doctor', name: '巫医', cost: 2, type: 'minion', attack: 2, hp: 2, art: '🪬', text: '战吼：恢复3点生命', battlecry: 'heal_3' , rarity: 'common'},
  { id: 'mana_wraith', name: '法力怨灵', cost: 2, type: 'minion', attack: 2, hp: 2, art: '👻', text: '法术伤害+1', spellDamage: 1 , rarity: 'common'},
  { id: 'armored_knight', name: '重甲骑士', cost: 3, type: 'minion', attack: 2, hp: 4, art: '🛡️', text: '嘲讽', taunt: true , rarity: 'common'},
  { id: 'battle_axe', name: '战斧', cost: 2, type: 'weapon', attack: 2, durability: 2, art: '🪓', text: '' , rarity: 'common'},
  { id: 'magic_missile', name: '魔法飞弹', cost: 1, type: 'spell', art: '✨', text: '造成1点伤害', effect: 'deal_1' , rarity: 'common'},
  { id: 'boulderfist_ogre', name: '石拳食人魔', cost: 5, type: 'minion', attack: 6, hp: 7, art: '👹', text: '' , rarity: 'rare'},
  ...
  { id: 'guardian_of_kings', name: '王者守卫', cost: 5, type: 'minion', attack: 5, hp: 5, art: '🛡️', text: '战吼：恢复4点生命', battlecry: 'heal_4' , rarity: 'rare'},
  { id: 'tundra_rhino', name: '苔原犀牛', cost: 4, type: 'minion', attack: 4, hp: 3, art: '🦏', text: '冲锋', charge: true, race: 'beast' , rarity: 'rare'},
  // --- New Power Cards (Engine & Finisher Expansion) ---
  // 构筑引擎：法术流
  { id: 'arcane_scholar', name: '奥秘学者', cost: 3, type: 'minion', attack: 2, hp: 4, art: '📖', text: '法术伤害+1，战吼：你手牌中所有法术牌费用-1', spellDamage: 1, battlecry: 'reduce_hand_spells' , rarity: 'common'},
  { id: 'mana_surge', name: '法力奔涌', cost: 4, type: 'spell', art: '🌀', text: '抽3张牌', effect: 'draw_3' , rarity: 'rare'},
  ...
  // 构筑引擎：随从增益
  { id: 'inspiring_leader', name: '鼓舞统帅', cost: 4, type: 'minion', attack: 3, hp: 5, art: '🎖️', text: '战吼：使所有友方随从+1/+1', battlecry: 'buff_all_1_1' , rarity: 'rare'},
  // 高费终结卡
  { id: 'abyss_lord', name: '深渊领主', cost: 8, type: 'minion', attack: 8, hp: 8, art: '👹', text: '战吼：对所有敌人造成3点伤害', battlecry: 'deal_3_all_incl_hero' , rarity: 'epic'},
  { id: 'titan_earthguard', name: '泰坦·大地守护者', cost: 9, type: 'minion', attack: 9, hp: 9, art: '🗻', text: '嘲讽·战吼：获得9点护甲', taunt: true, battlecry: 'gain_armor_9' , rarity: 'epic'},

  // =============== 中立新卡（15张） ===============
  { id: 'neutral_kobold', name: '地精盗贼', cost: 1, type: 'minion', attack: 1, hp: 3, art: '💰', text: '' , rarity: 'common'},
  { id: 'neutral_guard', name: '铁壁卫兵', cost: 2, type: 'minion', attack: 1, hp: 5, art: '🛡️', text: '嘲讽', taunt: true , rarity: 'common'},
  { id: 'neutral_rogue_knife', name: '淬毒匕首', cost: 1, type: 'weapon', attack: 1, durability: 2, art: '🗡️', text: '' , rarity: 'common'},
  { id: 'neutral_spell_2', name: '奥术震荡', cost: 2, type: 'spell', art: '💥', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'neutral_minion_3', name: '森林巨熊', cost: 3, type: 'minion', attack: 4, hp: 4, art: '🐻', text: '', race: 'beast' , rarity: 'common'},
  { id: 'neutral_minion_4', name: '岩甲守卫', cost: 4, type: 'minion', attack: 3, hp: 7, art: '🪨', text: '嘲讽', taunt: true , rarity: 'rare'},
  { id: 'neutral_minion_5', name: '战场老兵', cost: 5, type: 'minion', attack: 5, hp: 6, art: '🎖️', text: '战吼：使所有友方随从+1/+1', battlecry: 'buff_all_1_1' , rarity: 'rare'},
  { id: 'neutral_spell_6', name: '战争怒吼', cost: 3, type: 'spell', art: '📣', text: '使所有友方随从+3/+3', effect: 'buff_all_3_3' , rarity: 'rare'},
  { id: 'neutral_minion_7', name: '秘银巨像', cost: 6, type: 'minion', attack: 6, hp: 8, art: '🗿', text: '嘲讽', taunt: true , rarity: 'rare'},
  { id: 'neutral_spell_8', name: '烈焰风暴·改', cost: 7, type: 'spell', art: '🌋', text: '对所有敌人造成4点伤害', effect: 'deal_4_all' , rarity: 'epic'},
  { id: 'neutral_minion_9', name: '混沌领主', cost: 7, type: 'minion', attack: 8, hp: 7, art: '👹', text: '战吼：对所有敌方随从造成3点伤害', battlecry: 'deal_3_all' , rarity: 'epic'},
  { id: 'neutral_minion_10', name: '虚空观察者', cost: 4, type: 'minion', attack: 2, hp: 6, art: '👁️', text: '亡语：抽2张牌', deathrattle: 'draw_2_owner' , rarity: 'rare'},
  { id: 'neutral_spell_11', name: '时间扭曲', cost: 5, type: 'spell', art: '⏳', text: '获得2个法力水晶', effect: 'gain_mana_2' , rarity: 'rare'},
  { id: 'neutral_minion_12', name: '深渊触须', cost: 5, type: 'minion', attack: 3, hp: 7, art: '🦑', text: '亡语：召唤一个3/3召唤物', deathrattle: 'summon_3_3' , rarity: 'rare'},
  { id: 'neutral_minion_13', name: '黄金战士', cost: 4, type: 'minion', attack: 5, hp: 4, art: '🛡️', text: '战吼：获得2点护甲', battlecry: 'gain_armor_2' , rarity: 'rare'},

  // =============== 检索·牌库机制（7张） ===============
  { id: 'tutor_minion_1', name: '学徒引路', cost: 1, type: 'spell', art: '🧭', text: '检索：从牌库抽1张随从牌到手中', effect: 'tutor_minion' , rarity: 'common'},
  { id: 'tutor_spell_1', name: '智慧咏唱', cost: 1, type: 'spell', art: '📜', text: '检索：从牌库抽1张法术牌到手中', effect: 'tutor_spell' , rarity: 'common'},
  { id: 'tutor_low_2', name: '战术推演', cost: 2, type: 'spell', art: '🧠', text: '检索：从牌库抽1张费用2点或更低的牌', effect: 'tutor_cost_le2' , rarity: 'common'},
  { id: 'tutor_weapon_2', name: '军备库', cost: 2, type: 'spell', art: '⚔️', text: '检索：从牌库抽1张武器牌到手中', effect: 'tutor_weapon' , rarity: 'common'},
  { id: 'tutor_beast_2', name: '兽群呼唤', cost: 2, type: 'spell', art: '🐺', text: '检索：从牌库抽1张野兽牌到手中', effect: 'tutor_race_beast' , rarity: 'common'},
  { id: 'tutor_rare_3', name: '命运启示', cost: 3, type: 'spell', art: '🔮', text: '检索：从牌库抽2张稀有或更高稀有度的牌', effect: 'tutor_rare_plus_2' , rarity: 'common'},
  { id: 'tutor_spell_2', name: '深谋远虑', cost: 3, type: 'spell', art: '📚', text: '检索：从牌库抽2张法术牌到手中', effect: 'tutor_spell_2' , rarity: 'common'},

  // =============== 法师新卡（15张） ===============
  { id: 'mage_spark', name: '奥术火花', cost: 1, type: 'spell', art: '✨', text: '造成5点伤害，抽1张牌', effect: 'deal_5_draw_1' , rarity: 'rare'},
  { id: 'mage_apprentice', name: '法术学徒', cost: 2, type: 'minion', attack: 3, hp: 2, art: '🧙', text: '法术伤害+1', spellDamage: 1 , rarity: 'common'},
  { id: 'mage_frost_bolt', name: '冰霜箭', cost: 2, type: 'spell', art: '❄️', text: '造成3点伤害', effect: 'deal_3_face' , rarity: 'common'},
  ...
  { id: 'mage_sorcerer', name: '法术学家', cost: 5, type: 'minion', attack: 4, hp: 5, art: '📖', text: '战吼：抽1张牌', battlecry: 'draw_1' , rarity: 'rare'},
  { id: 'mage_frost_giant', name: '冰霜巨人', cost: 6, type: 'minion', attack: 7, hp: 7, art: '🧊', text: '' , rarity: 'rare'},
  { id: 'mage_scorch', name: '灼烧', cost: 1, type: 'spell', art: '🔥', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'mage_mana_wyrm', name: '法力浮龙', cost: 2, type: 'minion', attack: 1, hp: 3, art: '🐉', text: '法术伤害+1', spellDamage: 1 , rarity: 'common'},
  { id: 'mage_time_warp', name: '时空穿梭', cost: 7, type: 'spell', art: '⏳', text: '抽3张牌，并获得1个额外回合', effect: 'time_warp' , rarity: 'epic'},

  // =============== 战士新卡（15张） ===============
  { id: 'war_pierce', name: '破甲', cost: 1, type: 'spell', art: '🗡️', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'war_armor_up', name: '装甲强化', cost: 1, type: 'spell', art: '🛡️', text: '获得4点护甲', effect: 'gain_armor_4' , rarity: 'common'},
  { id: 'war_shield_maiden', name: '盾卫女郎', cost: 2, type: 'minion', attack: 2, hp: 4, art: '🛡️', text: '嘲讽', taunt: true , rarity: 'common'},
  { id: 'war_cleave', name: '顺劈斩', cost: 2, type: 'spell', art: '⚔️', text: '对所有敌方随从造成2点伤害', effect: 'consecration' , rarity: 'common'},
  { id: 'war_iron_skin', name: '钢铁皮肤', cost: 3, type: 'spell', art: '🛡️', text: '获得4点护甲', effect: 'gain_armor_4' , rarity: 'common'},
  { id: 'war_berserker_2', name: '狂暴战士', cost: 4, type: 'minion', attack: 5, hp: 4, art: '🪓', text: '' , rarity: 'rare'},
  { id: 'war_shield_bash', name: '盾牌猛击', cost: 3, type: 'spell', art: '🛡️', text: '造成5点伤害', effect: 'deal_5' , rarity: 'common'},
  { id: 'war_ironbark', name: '铁皮橡树', cost: 5, type: 'minion', attack: 4, hp: 8, art: '🌳', text: '嘲讽', taunt: true , rarity: 'rare'},
  ...
  // =============== 猎人新卡（15张） ===============
  { id: 'hun_steady', name: '稳固射击', cost: 1, type: 'spell', art: '🏹', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'hun_trap', name: '爆炸陷阱', cost: 2, type: 'spell', art: '💥', text: '对所有敌方随从造成2点伤害', effect: 'consecration' , rarity: 'common'},
  { id: 'hun_dog', name: '猎犬', cost: 2, type: 'minion', attack: 3, hp: 2, art: '🐕', text: '', race: 'beast' , rarity: 'common'},
  { id: 'hun_marksman', name: '神射手', cost: 3, type: 'minion', attack: 3, hp: 3, art: '🎯', text: '战吼：造成2点伤害', battlecry: 'deal_2' , rarity: 'common'},
  { id: 'hun_beast_call', name: '兽群呼唤', cost: 4, type: 'spell', art: '🐺', text: '召唤两个3/3召唤物', effect: 'summon_two_3_3' , rarity: 'rare'},
  { id: 'hun_wolf_pack', name: '狼群突袭', cost: 3, type: 'spell', art: '🐺', text: '使所有友方野兽+2/+2', effect: 'buff_beasts_2_2' , rarity: 'common'},
  { id: 'hun_hawk', name: '猎鹰', cost: 3, type: 'minion', attack: 3, hp: 2, art: '🦅', text: '冲锋', charge: true, race: 'beast' , rarity: 'common'},
  { id: 'hun_master', name: '驯兽大师', cost: 4, type: 'minion', attack: 3, hp: 4, art: '🐺', text: '战吼：使所有友方野兽+1/+1', battlecry: 'buff_beasts_1_1', race: 'beast' , rarity: 'rare'},
  { id: 'hun_crossbow', name: '重型弩', cost: 3, type: 'weapon', attack: 3, durability: 2, art: '🏹', text: '' , rarity: 'common'},
  { id: 'hun_beast_king_2', name: '兽王', cost: 7, type: 'minion', attack: 6, hp: 7, art: '🦁', text: '战吼：使所有友方野兽+2/+2', battlecry: 'buff_beasts_2_2', race: 'beast' , rarity: 'epic'},
  { id: 'hun_multi_shot', name: '多重射击', cost: 3, type: 'spell', art: '🏹', text: '对所有敌人造成3点伤害', effect: 'deal_3_all' , rarity: 'common'},
  { id: 'hun_tiger', name: '猛虎', cost: 5, type: 'minion', attack: 5, hp: 5, art: '🐯', text: '冲锋', charge: true, race: 'beast' , rarity: 'rare'},
  { id: 'hun_scout_2', name: '侦察兵', cost: 1, type: 'minion', attack: 1, hp: 2, art: '🔭', text: '战吼：抽1张牌', battlecry: 'draw_1' , rarity: 'common'},
  { id: 'hun_eagle_horn', name: '猎鹰之角', cost: 2, type: 'weapon', attack: 2, durability: 3, art: '🎺', text: '' , rarity: 'common'},
  { id: 'hun_mammoth', name: '猛犸', cost: 8, type: 'minion', attack: 8, hp: 8, art: '🦣', text: '嘲讽·战吼：召唤一个3/3', taunt: true, battlecry: 'summon_3_3', race: 'beast' , rarity: 'epic'},

  // =============== 圣骑士新卡（15张） ===============
  { id: 'pal_blessing', name: '祝福术', cost: 1, type: 'spell', art: '✨', text: '使一个友方随从+2/+2', effect: 'pw_shield' , rarity: 'common'},
  { id: 'pal_squire', name: '新兵', cost: 1, type: 'minion', attack: 1, hp: 2, art: '🛡️', text: '圣盾', divineShield: true , rarity: 'common'},
  { id: 'pal_divine_shield', name: '圣盾术', cost: 2, type: 'spell', art: '🛡️', text: '使一个友方随从+2/+2', effect: 'pw_shield' , rarity: 'common'},
  { id: 'pal_knight_2', name: '圣殿骑士', cost: 3, type: 'minion', attack: 3, hp: 4, art: '⚔️', text: '圣盾', divineShield: true , rarity: 'common'},
  { id: 'pal_heal_prayer', name: '治疗祷告', cost: 2, type: 'spell', art: '🙏', text: '恢复8点生命', effect: 'heal_8' , rarity: 'rare'},
  { id: 'pal_consecration_2', name: '神圣奉献', cost: 4, type: 'spell', art: '☀️', text: '对所有敌方随从造成3点伤害', effect: 'deal_3_all' , rarity: 'rare'},
  { id: 'pal_sword', name: '正义之剑', cost: 3, type: 'weapon', attack: 3, durability: 2, art: '⚔️', text: '战吼：使所有友方随从+1/+1', battlecry: 'buff_all_1_1' , rarity: 'common'},
  { id: 'pal_aurora', name: '晨光骑士', cost: 5, type: 'minion', attack: 4, hp: 6, art: '🌟', text: '圣盾', divineShield: true , rarity: 'rare'},
  { id: 'pal_sun_guard', name: '太阳守卫', cost: 6, type: 'minion', attack: 5, hp: 8, art: '☀️', text: '嘲讽·圣盾', taunt: true, divineShield: true , rarity: 'rare'},
  { id: 'pal_tirion', name: '提里奥·弗丁', cost: 8, type: 'minion', attack: 6, hp: 6, art: '👑', text: '嘲讽·圣盾·亡语：召唤一个4/4', taunt: true, divineShield: true, deathrattle: 'summon_4_4' , rarity: 'epic'},
  { id: 'pal_bless_army', name: '全军祝福', cost: 5, type: 'spell', art: '✨', text: '使所有友方随从+3/+3', effect: 'buff_all_3_3' , rarity: 'epic'},
  { id: 'pal_shieldbearer_2', name: '盾卫者', cost: 2, type: 'minion', attack: 0, hp: 7, art: '🛡️', text: '嘲讽', taunt: true , rarity: 'common'},
  { id: 'pal_hammer_wrath', name: '愤怒之锤', cost: 4, type: 'spell', art: '🔨', text: '造成5点伤害，抽1张牌', effect: 'deal_5_draw_1' , rarity: 'rare'},
  { id: 'pal_champion', name: '圣光冠军', cost: 7, type: 'minion', attack: 6, hp: 7, art: '⚔️', text: '战吼：使所有友方随从+2/+2', battlecry: 'buff_all_2_2' , rarity: 'epic'},
  { id: 'pal_guardian_2', name: '守护天使', cost: 4, type: 'minion', attack: 3, hp: 5, art: '👼', text: '战吼：恢复4点生命', battlecry: 'heal_4' , rarity: 'rare'},

  // =============== 牧师新卡（15张） ===============
  { id: 'pri_smite_2', name: '圣光惩击', cost: 1, type: 'spell', art: '✨', text: '造成3点伤害', effect: 'smite' , rarity: 'common'},
  { id: 'pri_heal_2', name: '治疗术', cost: 1, type: 'spell', art: '💚', text: '恢复5点生命', effect: 'heal_5' , rarity: 'common'},
  { id: 'pri_shadow_word', name: '暗言术·痛', cost: 3, type: 'spell', art: '🌑', text: '造成5点伤害', effect: 'deal_5' , rarity: 'common'},
  { id: 'pri_cleric', name: '暗影牧师', cost: 3, type: 'minion', attack: 3, hp: 4, art: '🌑', text: '吸血', lifesteal: true , rarity: 'common'},
  { id: 'pri_light_well', name: '光明之泉', cost: 2, type: 'minion', attack: 0, hp: 5, art: '⛲', text: '回合结束时恢复2点生命' , rarity: 'common'},
  { id: 'pri_mass_heal_2', name: '群体治疗·强', cost: 5, type: 'spell', art: '💫', text: '恢复所有友方角色5点生命', effect: 'mass_heal' , rarity: 'rare'},
  { id: 'pri_holy_nova_2', name: '神圣新星·强', cost: 5, type: 'spell', art: '🌟', text: '对所有敌人造成3点伤害，治疗友军', effect: 'holy_nova' , rarity: 'rare'},
  { id: 'pri_guardian', name: '守护牧师', cost: 4, type: 'minion', attack: 3, hp: 6, art: '🛡️', text: '嘲讽', taunt: true , rarity: 'rare'},
  { id: 'pri_resurrect', name: '复活术', cost: 2, type: 'spell', art: '💀', text: '召唤两个3/3召唤物', effect: 'summon_two_3_3' , rarity: 'rare'},
  { id: 'pri_shadow_master', name: '暗影大师', cost: 6, type: 'minion', attack: 5, hp: 6, art: '🌑', text: '吸血·法术伤害+1', lifesteal: true, spellDamage: 1 , rarity: 'rare'},
  { id: 'pri_divine', name: '神圣化身', cost: 7, type: 'minion', attack: 7, hp: 7, art: '👼', text: '圣盾·战吼：恢复6点生命', divineShield: true, battlecry: 'heal_6' , rarity: 'epic'},
  { id: 'pri_holy_fire_2', name: '神圣之火·强', cost: 6, type: 'spell', art: '🔥', text: '造成6点伤害，恢复6点生命', effect: 'holy_fire' , rarity: 'rare'},
  { id: 'pri_psychic', name: '心灵视界', cost: 2, type: 'spell', art: '🧠', text: '抽2张牌', effect: 'draw_2' , rarity: 'common'},
  { id: 'pri_guardian_angel', name: '守护天使长', cost: 8, type: 'minion', attack: 6, hp: 9, art: '👼', text: '嘲讽·战吼：恢复6点生命', taunt: true, battlecry: 'heal_6' , rarity: 'epic'},
  { id: 'pri_mind_blast', name: '心灵震爆', cost: 4, type: 'spell', art: '🧠', text: '造成6点伤害', effect: 'deal_6_face' , rarity: 'rare'},

  // =============== 术士新卡（15张） ===============
  { id: 'war_drain', name: '生命汲取', cost: 2, type: 'spell', art: '🩸', text: '造成3点伤害', effect: 'deal_3_face' , rarity: 'common'},
  { id: 'war_imp', name: '恶魔小鬼', cost: 1, type: 'minion', attack: 1, hp: 2, art: '😈', text: '' , rarity: 'common'},
  { id: 'war_demon', name: '恶魔猎手', cost: 3, type: 'minion', attack: 4, hp: 3, art: '👹', text: '冲锋', charge: true , rarity: 'common'},
  { id: 'war_hellfire', name: '地狱烈焰', cost: 4, type: 'spell', art: '🔥', text: '对所有角色造成4点伤害', effect: 'deal_4_all' , rarity: 'rare'},
  ...
  { id: 'war_demonlord', name: '恶魔领主', cost: 8, type: 'minion', attack: 8, hp: 8, art: '👹', text: '战吼：对所有敌人造成3点伤害', battlecry: 'deal_3_all_incl_hero' , rarity: 'epic'},
  { id: 'war_fel_dog', name: '地狱犬', cost: 2, type: 'minion', attack: 3, hp: 2, art: '🐕', text: '', race: 'beast' , rarity: 'common'},
  { id: 'war_soul_drain', name: '灵魂吸取', cost: 4, type: 'spell', art: '🩸', text: '造成5点伤害', effect: 'deal_5' , rarity: 'rare'},
  { id: 'war_void_walker', name: '虚空行者', cost: 1, type: 'minion', attack: 1, hp: 3, art: '👁️', text: '嘲讽', taunt: true , rarity: 'common'},

  // =============== 新机制卡牌（进化/复生/发现/回响/连锁/魔力增幅） ===============
  // ---- 进化系（影之诗） ----
  { id: 'evo_knight', name: '进化骑士', cost: 3, type: 'minion', attack: 3, hp: 3, art: '🛡️', text: '进化：造成2点伤害', evolve: true, evolveEffect: 'deal_2' , rarity: 'common'},
  { id: 'evo_dragon', name: '进化巨龙', cost: 5, type: 'minion', attack: 5, hp: 4, art: '🐉', text: '进化：对所有敌人造成2点伤害', evolve: true, evolveEffect: 'deal_2_all' , rarity: 'rare'},
  { id: 'evo_beast_tamer', name: '进化驯兽师', cost: 4, type: 'minion', attack: 3, hp: 4, art: '🐺', text: '进化：所有友方野兽+1/+1', evolve: true, evolveEffect: 'buff_beasts_1_1', race: 'beast' , rarity: 'rare'},
  { id: 'evo_priest', name: '进化牧师', cost: 4, type: 'minion', attack: 4, hp: 4, art: '🙏', text: '进化：恢复4点生命', evolve: true, evolveEffect: 'heal_4' , rarity: 'rare'},
  { id: 'evo_summoner', name: '进化召唤师', cost: 5, type: 'minion', attack: 4, hp: 4, art: '🔮', text: '进化：召唤一个2/2随从', evolve: true, evolveEffect: 'summon_2_2' , rarity: 'rare'},
  { id: 'evo_guardian', name: '进化守卫', cost: 4, type: 'minion', attack: 2, hp: 6, art: '🛡️', text: '嘲讽·进化：获得3点护甲', evolve: true, evolveEffect: 'gain_armor_3', taunt: true , rarity: 'rare'},
  { id: 'evo_frost', name: '进化冰龙', cost: 6, type: 'minion', attack: 6, hp: 5, art: '🐲', text: '进化：冻结一个敌方随从', evolve: true, evolveEffect: 'freeze_random' , rarity: 'rare'},
  { id: 'evo_legend', name: '进化贤者', cost: 7, type: 'minion', attack: 6, hp: 6, art: '🌟', text: '进化：抽1张牌，恢复4点生命', evolve: true, evolveEffect: 'heal_4' , rarity: 'legendary'},

  // ---- 复生系（游戏王墓地/炉石复生） ----
  { id: 'reb_undead', name: '不死骷髅', cost: 2, type: 'minion', attack: 2, hp: 2, art: '💀', text: '复生（以1点生命复活）', rebirth: true, rebirthHp: 1 , rarity: 'common'},
  { id: 'reb_phoenix', name: '涅槃凤凰', cost: 4, type: 'minion', attack: 4, hp: 3, art: '🔥', text: '复生（以3点生命复活）', rebirth: true, rebirthHp: 3 , rarity: 'rare'},
  { id: 'reb_ghost', name: '幽灵武士', cost: 3, type: 'minion', attack: 3, hp: 3, art: '👻', text: '复生（以2点生命复活）', rebirth: true, rebirthHp: 2 , rarity: 'common'},
  { id: 'reb_serpent', name: '九头蛇', cost: 6, type: 'minion', attack: 5, hp: 5, art: '🐍', text: '复生（以4点生命复活）', rebirth: true, rebirthHp: 4, race: 'beast' , rarity: 'rare'},

  // ---- 发现系（炉石传说 Discover） ----
  { id: 'disc_mage', name: '奥术探索', cost: 3, type: 'spell', art: '🔮', text: '发现一张本职业卡牌', discoverFrom: 'class', effect: 'draw_1' , rarity: 'common'},
  { id: 'disc_paladin', name: '圣光指引', cost: 2, type: 'spell', art: '✨', text: '发现一张本职业卡牌', discoverFrom: 'class', effect: 'draw_1' , rarity: 'common'},
  { id: 'disc_hunter', name: '野外侦察', cost: 2, type: 'spell', art: '🔭', text: '发现一张本职业卡牌', discoverFrom: 'class', effect: 'draw_1' , rarity: 'common'},

  // ---- 回响系（炉石传说 Echo） ----
  { id: 'echo_dagger', name: '回响飞刃', cost: 1, type: 'spell', art: '🔪', text: '造成1点伤害（回响：本回合可再次打出）', effect: 'deal_1', echo: true , rarity: 'common'},
  { id: 'echo_shield', name: '回响护盾', cost: 1, type: 'spell', art: '🛡️', text: '获得2点护甲（回响：本回合可再次打出）', effect: 'gain_armor_2', echo: true , rarity: 'common'},

  // ---- 连锁系（游戏王 Chain） ----
  { id: 'chain_fire', name: '连锁火球', cost: 3, type: 'spell', art: '🔥', text: '对所有敌人造成3点伤害。若本回合已打出2张卡，额外抽1张牌', effect: 'deal_3_all', chain: 3, chainEffect: 'draw_1' , rarity: 'common'},
  { id: 'chain_guard', name: '连锁守护', cost: 2, type: 'spell', art: '🛡️', text: '获得2点护甲。若本回合已打出3张卡，所有随从+1/+1', effect: 'gain_armor_2', chain: 4, chainEffect: 'buff_all_1_1' , rarity: 'common'},

  // ---- 魔力增幅系（影之诗 Spellboost） ----
  { id: 'boost_fireball', name: '增幅火球', cost: 6, type: 'spell', art: '🔥', text: '造成6点伤害。魔力增幅：每使用一张法术，费用-1', effect: 'deal_6_face', spellboost: 4 , rarity: 'epic'},
  { id: 'boost_blizzard', name: '增幅暴风雪', cost: 7, type: 'spell', art: '❄️', text: '对所有敌方随从造成3点伤害并冻结。魔力增幅：每使用一张法术，费用-1', effect: 'blizzard', spellboost: 5 , rarity: 'epic'},

  // ===================== ROGUE (盗贼) =====================
  { id: 'backstab', name: '背刺', cost: 1, type: 'spell', art: '🔪', text: '造成3点伤害', effect: 'deal_3_face' , rarity: 'common'},
  { id: 'sin_strike', name: '影袭', cost: 2, type: 'spell', art: '🌑', text: '造成3点伤害', effect: 'deal_3_face' , rarity: 'common'},
  { id: 'eviscerate', name: '刺骨', cost: 3, type: 'spell', art: '🗡️', text: '造成5点伤害', effect: 'deal_5' , rarity: 'common'},
  { id: 'fan_knives', name: '刀扇', cost: 3, type: 'spell', art: '🌀', text: '对所有敌人造成1点伤害并抽1张牌', effect: 'fan_of_knives' , rarity: 'common'},
  { id: 'sap', name: '闷棍', cost: 3, type: 'spell', art: '🪄', text: '消灭一个敌方随从', effect: 'assassinate' , rarity: 'common'},
  { id: 'poison_blade', name: '淬毒之刃', cost: 2, type: 'weapon', attack: 2, durability: 2, art: '⚔️', text: '武器' , rarity: 'common'},
  { id: 'stealth_knife', name: '潜行匕首', cost: 1, type: 'weapon', attack: 1, durability: 3, art: '🗡️', text: '武器' , rarity: 'common'},
  { id: 'sprint', name: '疾跑', cost: 4, type: 'spell', art: '💨', text: '抽3张牌', effect: 'draw_3' , rarity: 'rare'},
  { id: 'combo_strike', name: '连击之刃', cost: 4, type: 'minion', attack: 3, hp: 4, art: '⚡', text: '战吼：造成2点伤害', battlecry: 'deal_2' , rarity: 'rare'},
  { id: 'shadow_step', name: '暗影步', cost: 1, type: 'spell', art: '🌫️', text: '回响·获得1点法力水晶并抽一张牌', effect: 'gain_mana_draw', echo: true , rarity: 'common'},
  { id: 'bribery', name: '收买', cost: 4, type: 'spell', art: '💰', text: '获得一个敌方随从的控制权', effect: 'mind_control' , rarity: 'rare'},
  { id: 'master_poisoner', name: '淬毒大师', cost: 5, type: 'minion', attack: 4, hp: 4, art: '🧪', text: '剧毒', poisonous: true , rarity: 'rare'},
  { id: 'rogue_legend', name: '影之君主', cost: 7, type: 'minion', attack: 6, hp: 6, art: '👑', text: '冲锋·潜行', charge: true, stealth: true , rarity: 'legendary'},
  // ===================== DRUID (德鲁伊) =====================
  { id: 'claw', name: '爪击', cost: 1, type: 'spell', art: '🐾', text: '造成3点伤害', effect: 'deal_3_face' , rarity: 'common'},
  { id: 'bite', name: '撕咬', cost: 2, type: 'spell', art: '🦷', text: '获得4点护甲', effect: 'gain_armor_4' , rarity: 'common'},
  { id: 'wild_growth', name: '野性成长', cost: 2, type: 'spell', art: '🌱', text: '获得1点法力水晶', effect: 'gain_mana_1' , rarity: 'common'},
  { id: 'ironbark', name: '铁树皮', cost: 4, type: 'spell', art: '🌳', text: '获得8点护甲', effect: 'gain_armor_8' , rarity: 'rare'},
  { id: 'mark_wild', name: '野性印记', cost: 3, type: 'spell', art: '🖐️', text: '所有友方随从+2/+2', effect: 'buff_friendly_2_2' , rarity: 'common'},
  { id: 'moonfire', name: '月火术', cost: 1, type: 'spell', art: '🌙', text: '造成1点伤害', effect: 'deal_1' , rarity: 'common'},
  { id: 'nourish', name: '滋养', cost: 4, type: 'spell', art: '💧', text: '抽3张牌', effect: 'draw_3' , rarity: 'rare'},
  ...
  { id: 'storm_giant', name: '风暴巨人', cost: 7, type: 'minion', attack: 6, hp: 6, art: '🗿', text: '风怒', windfury: true , rarity: 'epic'},
  { id: 'totem_army', name: '图腾军团', cost: 5, type: 'spell', art: '🪔', text: '召唤两个2/2嘲讽图腾', effect: 'summon_two_0_2' , rarity: 'epic'},
  { id: 'elem_surge', name: '元素涌动', cost: 3, type: 'spell', art: '✨', text: '造成3点伤害并抽1张牌', effect: 'deal_3_draw_1' , rarity: 'common'},

  // ===================== 体系卡牌：元素/机械/龙/鱼人/恶魔/野兽 =====================
  { id: 'elem_spark', name: '火花元素', cost: 1, type: 'minion', attack: 1, hp: 2, art: '✨', text: '元素', race: 'elemental' , rarity: 'common'},
  { id: 'elem_wave', name: '焰浪元素', cost: 3, type: 'minion', attack: 3, hp: 4, art: '🌊', text: '元素·战吼：抽1张牌', battlecry: 'draw_1', race: 'elemental' , rarity: 'common'},
  { id: 'elem_ice', name: '冰晶元素', cost: 4, type: 'minion', attack: 3, hp: 5, art: '❄️', text: '元素·嘲讽', taunt: true, race: 'elemental' , rarity: 'rare'},
  { id: 'mech_drone', name: '侦查无人机', cost: 2, type: 'minion', attack: 2, hp: 2, art: '🚁', text: '机械', race: 'mech' , rarity: 'common'},
  { id: 'mech_repair', name: '修理机器人', cost: 3, type: 'minion', attack: 2, hp: 3, art: '🔧', text: '机械·战吼：恢复3点生命', battlecry: 'heal_3', race: 'mech' , rarity: 'common'},
  { id: 'mech_giant', name: '巨型机甲', cost: 6, type: 'minion', attack: 6, hp: 6, art: '🤖', text: '机械·嘲讽', taunt: true, race: 'mech' , rarity: 'rare'},
  { id: 'dragon_whelp', name: '幼龙', cost: 1, type: 'minion', attack: 1, hp: 1, art: '🐲', text: '龙', race: 'dragon' , rarity: 'common'},
  { id: 'dragon_elder', name: '龙族长者', cost: 5, type: 'minion', attack: 4, hp: 5, art: '🐉', text: '龙·战吼：若手牌有龙则+1/+1', battlecry: 'dragon_buff', race: 'dragon' , rarity: 'rare'},
  { id: 'dragon_queen', name: '龙母', cost: 7, type: 'minion', attack: 5, hp: 8, art: '🐲', text: '龙·嘲讽', taunt: true, race: 'dragon' , rarity: 'epic'},
  { id: 'murloc_scout', name: '鱼人斥候', cost: 1, type: 'minion', attack: 1, hp: 1, art: '🐟', text: '鱼人·冲锋', charge: true, race: 'murloc' , rarity: 'common'},
  { id: 'murloc_tide', name: '鱼人潮汐', cost: 3, type: 'minion', attack: 3, hp: 2, art: '🌊', text: '鱼人·战吼：所有鱼人+1/+1', battlecry: 'buff_murlocs_1_1', race: 'murloc' , rarity: 'common'},
  ...
  { id: 'ro_poison_bite', name: '淬毒撕咬', cost: 2, type: 'spell', art: '☠️', text: '造成3点伤害', effect: 'deal_3' , rarity: 'common'},
  { id: 'ro_shadow_strike', name: '影袭', cost: 3, type: 'spell', art: '🌑', text: '造成5点伤害', effect: 'deal_5' , rarity: 'common'},
  { id: 'ro_blade_flurry', name: '刀扇乱舞', cost: 3, type: 'spell', art: '🌀', text: '对所有敌方随从造成1点伤害，抽一张牌', effect: 'fan_of_knives' , rarity: 'common'},
  { id: 'ro_ambush', name: '埋伏突袭', cost: 2, type: 'spell', art: '🕶️', text: '召唤一个1/1冲锋小兵', effect: 'summon_1_1_charge' , rarity: 'common'},
  { id: 'ro_sprint_2', name: '疾跑', cost: 4, type: 'spell', art: '🏃', text: '抽三张牌', effect: 'draw_3' , rarity: 'rare'},
  { id: 'ro_stealth_ally', name: '暗影帷幕', cost: 2, type: 'spell', art: '🌫️', text: '所有友方随从+1/+1', effect: 'buff_all_1_1' , rarity: 'common'},
  { id: 'ro_assassin', name: '潜行刺客', cost: 3, type: 'minion', attack: 3, hp: 3, art: '🗡️', text: '潜行', stealth: true , rarity: 'common'},
  { id: 'ro_poison_master', name: '毒刃大师', cost: 4, type: 'minion', attack: 3, hp: 4, art: '☠️', text: '剧毒：消灭受到其伤害的随从', poisonous: true , rarity: 'rare'},
  { id: 'ro_combo_master', name: '连击大师', cost: 5, type: 'minion', attack: 4, hp: 5, art: '⚡', text: '战吼：所有友方随从+2/+2', battlecry: 'buff_all_2_2' , rarity: 'rare'},
  { id: 'ro_bounty_hunter', name: '赏金猎人', cost: 3, type: 'minion', attack: 3, hp: 2, art: '💰', text: '战吼：抽一张牌', battlecry: 'draw_1' , rarity: 'common'},
  { id: 'ro_shadow_master', name: '暗影宗师', cost: 6, type: 'minion', attack: 5, hp: 5, art: '🌌', text: '战吼：对所有敌方随从造成3点伤害', battlecry: 'deal_3_all' , rarity: 'rare'},
  { id: 'ro_poison_knife', name: '淬毒短刃', cost: 2, type: 'weapon', attack: 1, durability: 3, art: '🗡️', text: '1/3武器' , rarity: 'common'},
  { id: 'ro_dagger_dancer', name: '刀扇舞者', cost: 4, type: 'minion', attack: 3, hp: 5, art: '💃', text: '风怒：每回合可攻击两次', windfury: true , rarity: 'rare'},
  { id: 'ro_cutthroat', name: '冷血杀手', cost: 5, type: 'minion', attack: 4, hp: 4, art: '🔪', text: '潜行·战吼：造成2点伤害', battlecry: 'deal_2', stealth: true , rarity: 'rare'},
  { id: 'ro_thief', name: '偷窃者', cost: 2, type: 'minion', attack: 2, hp: 3, art: '🕵️', text: '战吼：抽一张牌', battlecry: 'draw_1' , rarity: 'common'},
  { id: 'dr_moonfire_2', name: '月火术', cost: 1, type: 'spell', art: '🌙', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'dr_wild_power', name: '野性之力', cost: 3, type: 'spell', art: '🌿', text: '所有野兽随从+2/+2', effect: 'buff_beasts_2_2' , rarity: 'common'},
  { id: 'dr_nature_force', name: '自然之力', cost: 4, type: 'spell', art: '🌳', text: '召唤两个2/2树人', effect: 'summon_two_2_2' , rarity: 'rare'},
  { id: 'dr_starfire_2', name: '星火术', cost: 5, type: 'spell', art: '🌟', text: '造成5点伤害', effect: 'deal_5' , rarity: 'rare'},
  { id: 'dr_jungle_ward', name: '丛林守护', cost: 3, type: 'spell', art: '🌴', text: '获得4点护甲', effect: 'gain_armor_4' , rarity: 'common'},
  { id: 'dr_bark_skin', name: '树皮术', cost: 2, type: 'spell', art: '🪵', text: '获得2点护甲', effect: 'gain_armor_2' , rarity: 'common'},
  { id: 'dr_swipe', name: '横扫', cost: 4, type: 'spell', art: '🌪️', text: '对所有敌方随从造成4点伤害', effect: 'deal_4_all' , rarity: 'rare'},
  { id: 'dr_vine', name: '藤蔓缠绕', cost: 2, type: 'spell', art: '🌿', text: '冻结一个敌方随从', effect: 'freeze_enemy' , rarity: 'common'},
  { id: 'dr_bear_form', name: '巨熊形态', cost: 3, type: 'minion', attack: 4, hp: 4, art: '🐻', text: '野兽', race: 'beast' , rarity: 'common'},
  { id: 'dr_guardian_2', name: '森林守护者', cost: 4, type: 'minion', attack: 3, hp: 6, art: '🌲', text: '嘲讽', taunt: true , rarity: 'rare'},
  { id: 'dr_apprentice', name: '德鲁伊学徒', cost: 2, type: 'minion', attack: 2, hp: 3, art: '🌱', text: '' , rarity: 'common'},
  { id: 'dr_seer', name: '自然先知', cost: 4, type: 'minion', attack: 3, hp: 4, art: '🔮', text: '法术伤害+1', spellDamage: 1 , rarity: 'rare'},
  { id: 'dr_ancien', name: '远古树人', cost: 6, type: 'minion', attack: 6, hp: 6, art: '🪵', text: '嘲讽', taunt: true , rarity: 'rare'},
  { id: 'dr_elder', name: '橡木长老', cost: 5, type: 'minion', attack: 4, hp: 6, art: '🌳', text: '嘲讽', taunt: true , rarity: 'rare'},
  { id: 'dr_wolf_rider', name: '狼骑兵', cost: 3, type: 'minion', attack: 3, hp: 1, art: '🐺', text: '冲锋', charge: true , rarity: 'common'},
  { id: 'dr_root', name: '树根缠绕', cost: 1, type: 'spell', art: '🌱', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'sa_lightning_2', name: '闪电链', cost: 2, type: 'spell', art: '⚡', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'sa_heal_totem', name: '治疗图腾', cost: 2, type: 'spell', art: '🩹', text: '恢复4点生命', effect: 'heal_4' , rarity: 'common'},
  { id: 'sa_storm_fury', name: '风暴之怒', cost: 4, type: 'spell', art: '⛈️', text: '对所有敌方随从造成3点伤害', effect: 'deal_3_all' , rarity: 'rare'},
  ...
  { id: 'sa_tide_priest', name: '潮汐祭司', cost: 4, type: 'minion', attack: 3, hp: 5, art: '🌊', text: '战吼：恢复4点生命', battlecry: 'heal_4' , rarity: 'rare'},
  { id: 'sa_thunder_herald', name: '雷霆使者', cost: 5, type: 'minion', attack: 5, hp: 5, art: '⛈️', text: '战吼：对所有敌方随从造成2点伤害', battlecry: 'deal_2_all' , rarity: 'rare'},
  { id: 'sa_wind_totem', name: '风怒图腾', cost: 3, type: 'minion', attack: 0, hp: 3, art: '💨', text: '法术伤害+1', spellDamage: 1 , rarity: 'common'},
  { id: 'sa_earth_elemental', name: '大地元素', cost: 6, type: 'minion', attack: 6, hp: 6, art: '🗿', text: '嘲讽', taunt: true , rarity: 'rare'},
  { id: 'sa_magma', name: '熔岩幼崽', cost: 2, type: 'minion', attack: 2, hp: 3, art: '🌋', text: '' , rarity: 'common'},
  { id: 'sa_storm_watcher', name: '风暴守望者', cost: 4, type: 'minion', attack: 4, hp: 5, art: '🦅', text: '' , rarity: 'rare'},
  // ===== 第11轮：猎人体系扩充（野兽/直伤） =====
  { id: 'hun_rapid_fire', name: '急速射击', cost: 1, type: 'spell', art: '🏹', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'hun_tracking', name: '追踪术', cost: 2, type: 'spell', art: '🎯', text: '抽2张牌', effect: 'draw_2' , rarity: 'common'},
  { id: 'hun_cobra', name: '剧毒眼镜蛇', cost: 2, type: 'minion', attack: 2, hp: 2, art: '🐍', text: '剧毒', poisonous: true, race: 'beast' , rarity: 'common'},
  { id: 'hun_pack_leader', name: '狼群领袖', cost: 4, type: 'minion', attack: 3, hp: 3, art: '🐺', text: '战吼：你的野兽随从获得+1/+1', battlecry: 'buff_beasts_1_1', race: 'beast' , rarity: 'rare'},
  ...
  { id: 'pal_might', name: '力量祝福', cost: 2, type: 'spell', art: '💪', text: '你的所有随从获得+1/+1', effect: 'buff_all_1_1' , rarity: 'common'},
  { id: 'pal_zealot', name: '狂热圣骑士', cost: 3, type: 'minion', attack: 3, hp: 3, art: '🛡️', text: '战吼：获得2点护甲', battlecry: 'gain_armor_2' , rarity: 'common'},
  { id: 'pal_guardian_3', name: '圣殿守卫', cost: 4, type: 'minion', attack: 3, hp: 5, art: '🏰', text: '嘲讽·圣盾', taunt: true, divineShield: true , rarity: 'rare'},
  { id: 'pal_light_2', name: '圣光闪耀', cost: 3, type: 'spell', art: '✨', text: '恢复8点生命', effect: 'heal_8' , rarity: 'rare'},
  { id: 'pal_righteousness', name: '正义裁决', cost: 5, type: 'spell', art: '⚖️', text: '对所有敌方随从造成3点伤害', effect: 'deal_3_all' , rarity: 'rare'},
  { id: 'pal_champion_2', name: '圣殿冠军', cost: 8, type: 'minion', attack: 6, hp: 7, art: '👼', text: '圣盾·嘲讽·战吼：所有随从+1/+1', divineShield: true, taunt: true, battlecry: 'buff_all_1_1' , rarity: 'epic'},
  // ===== 第11轮：术士体系扩充（恶魔/直伤/自残） =====
  { id: 'war_soulfire', name: '灵魂之火', cost: 2, type: 'spell', art: '🔥', text: '造成5点伤害', effect: 'deal_5' , rarity: 'common'},
  { id: 'war_felguard', name: '恶魔卫士', cost: 3, type: 'minion', attack: 3, hp: 4, art: '👹', text: '嘲讽', taunt: true, race: 'demon' , rarity: 'common'},
  { id: 'war_darkbargain', name: '黑暗契约', cost: 4, type: 'spell', art: '📜', text: '获得4点护甲', effect: 'gain_armor_4' , rarity: 'rare'},
  { id: 'war_shadowflame', name: '暗影烈焰', cost: 5, type: 'spell', art: '🌑', text: '对所有敌方随从造成4点伤害', effect: 'deal_4_all' , rarity: 'epic'},
  { id: 'war_infernal', name: '地狱火', cost: 7, type: 'minion', attack: 6, hp: 6, art: '☄️', text: '战吼：对所有敌方随从造成2点伤害', battlecry: 'deal_2_all', race: 'demon' , rarity: 'epic'},
  { id: 'war_demonheart', name: '恶魔之心', cost: 6, type: 'spell', art: '💜', text: '恢复8点生命', effect: 'heal_8' , rarity: 'epic'},
  // ===== 第12轮：牧师体系扩充（+6） =====
  { id: 'pri_shadow_pain', name: '暗言术：痛', cost: 2, type: 'spell', art: '💜', text: '造成3点伤害', effect: 'deal_3' , rarity: 'common'},
  { id: 'pri_holy_shield', name: '神圣护盾', cost: 2, type: 'spell', art: '🛡️', text: '获得4点护甲', effect: 'gain_armor_4' , rarity: 'common'},
  { id: 'pri_spirit_priest', name: '灵魂祭司', cost: 3, type: 'minion', attack: 3, hp: 4, art: '👻', text: '战吼：恢复4点生命', battlecry: 'heal_4' , rarity: 'common'},
  { id: 'pri_mind_spike', name: '心灵尖刺', cost: 3, type: 'spell', art: '🗡️', text: '造成5点伤害', effect: 'deal_5' , rarity: 'common'},
  { id: 'pri_holy_champion', name: '圣光勇士', cost: 5, type: 'minion', attack: 4, hp: 5, art: '⚔️', text: '战吼：所有随从获得+1/+1', battlecry: 'buff_all_1_1' , rarity: 'rare'},
  { id: 'pri_shadow_madness', name: '暗影狂乱', cost: 5, type: 'spell', art: '🌑', text: '控制一个敌方随从', effect: 'mind_control' , rarity: 'rare'},
  // ===== 第12轮：德鲁伊体系扩充（+6） =====
  { id: 'dru_growth', name: '成长', cost: 2, type: 'spell', art: '🌱', text: '获得3点护甲', effect: 'gain_armor_3' , rarity: 'common'},
  { id: 'dru_savage_roar', name: '野蛮咆哮', cost: 3, type: 'spell', art: '🦁', text: '所有随从获得+2/+2', effect: 'buff_all_2_2' , rarity: 'common'},
  ...
  { id: 'war_frothing', name: '狂战士', cost: 4, type: 'minion', attack: 3, hp: 4, art: '🪓', text: '激怒：攻击力+2', enrage: 2 , rarity: 'rare'},
  { id: 'war_grommash', name: '格罗玛什', cost: 6, type: 'minion', attack: 5, hp: 5, art: '⚔️', text: '冲锋', charge: true , rarity: 'rare'},
  // ===== 第12轮：萨满体系扩充（+4） =====
  { id: 'sha_rockbiter', name: '石化武器', cost: 1, type: 'spell', art: '🪨', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'sha_healing_rain', name: '治疗之雨', cost: 3, type: 'spell', art: '🌧️', text: '恢复4点生命', effect: 'heal_4' , rarity: 'common'},
  { id: 'sha_totem_carver', name: '图腾雕刻者', cost: 3, type: 'minion', attack: 2, hp: 4, art: '🗿', text: '战吼：召唤一个1/1冲锋图腾', battlecry: 'summon_1_1_charge' , rarity: 'common'},
  { id: 'sha_elem_destruction', name: '元素毁灭', cost: 5, type: 'spell', art: '⚡', text: '对所有敌方随从造成4点伤害', effect: 'deal_4_all' , rarity: 'epic'},
  // ===== 第12轮：法师+2 =====
  { id: 'mag_frost_nova', name: '冰霜新星', cost: 3, type: 'spell', art: '❄️', text: '冻结所有敌方随从', effect: 'freeze_all' , rarity: 'common'},
  { id: 'mag_arcane_blast', name: '奥术冲击', cost: 4, type: 'spell', art: '💫', text: '造成5点伤害，抽1张牌', effect: 'deal_5_draw_1' , rarity: 'rare'},
  // ===== 第12轮：猎人+2 =====
  { id: 'hun_deadly_shot', name: '致命射击', cost: 3, type: 'spell', art: '🎯', text: '消灭一个敌方随从', effect: 'assassinate' , rarity: 'common'},
  ...
  // ===== 第12轮：盗贼+2 =====
  { id: 'ro_backstab', name: '背刺', cost: 1, type: 'spell', art: '🗡️', text: '造成2点伤害', effect: 'deal_2' , rarity: 'common'},
  { id: 'ro_sap', name: '闷棍', cost: 3, type: 'spell', art: '💫', text: '冻结一个敌方随从', effect: 'freeze_enemy' , rarity: 'common'},
  // ===== 第12轮：中立+2 =====
  { id: 'neu_bloodfen', name: '血沼迅猛龙', cost: 2, type: 'minion', attack: 3, hp: 2, art: '🦖', text: '', race: 'beast' , rarity: 'common'},
  { id: 'neu_senjin', name: '森金持盾卫士', cost: 4, type: 'minion', attack: 3, hp: 5, art: '🛡️', text: '嘲讽', taunt: true , rarity: 'rare'},

  // ===== 第15轮：状态机制卡（中毒/易伤/虚弱）=====
  { id: 'hun_poison_arrow', name: '剧毒之箭', cost: 3, type: 'spell', art: '🏹', text: '对敌方英雄施加5层中毒', effect: 'poison_face_5' , rarity: 'rare'},
  { id: 'hun_venom_trap', name: '淬毒陷阱', cost: 2, type: 'spell', art: '🪤', text: '对敌方英雄施加3层中毒，抽1张牌', effect: 'poison_face_3_draw' , rarity: 'common'},
  { id: 'sha_break_armor', name: '破甲重击', cost: 2, type: 'spell', art: '🔨', text: '对敌方英雄施加2层易伤并造成2点伤害', effect: 'vuln_face_2_dmg2' , rarity: 'common'},
  { id: 'sha_confusion', name: '迷乱之术', cost: 4, type: 'spell', art: '🌀', text: '对敌方英雄施加3层虚弱，抽1张牌', effect: 'weak_face_3_draw' , rarity: 'rare'},

  { id: 'mage_epic_manaflood', name: '奥术洪流', cost: 4, type: 'spell', art: '🌀', text: '抽3张牌', effect: 'draw_3' , rarity: 'epic'},
  { id: 'mage_epic_meteor', name: '陨石术', cost: 6, type: 'spell', art: '☄️', text: '对所有敌人造成4点伤害', effect: 'deal_4_all' , rarity: 'epic'},
  { id: 'war_epic_bastion', name: '堡垒壁垒', cost: 3, type: 'spell', art: '🛡️', text: '获得8点护甲', effect: 'gain_armor_8' , rarity: 'epic'},
  { id: 'war_epic_execution', name: '处决', cost: 4, type: 'spell', art: '⚔️', text: '造成6点伤害', effect: 'deal_6_face' , rarity: 'epic'},
  { id: 'ro_epic_toxic', name: '剧毒爆发', cost: 3, type: 'spell', art: '☠️', text: '使敌人中毒5层', effect: 'poison_face_5' , rarity: 'epic'},
  { id: 'ro_epic_shadowy', name: '幽影突袭', cost: 2, type: 'spell', art: '🌑', text: '造成5点伤害，抽1张牌', effect: 'deal_5_draw_1' , rarity: 'epic'},
  { id: 'dru_epic_wildswarm', name: '自然大军', cost: 5, type: 'spell', art: '🌿', text: '召唤两个3/3野兽', effect: 'summon_two_3_3' , rarity: 'epic'},
  { id: 'dru_epic_savage', name: '野蛮咆哮', cost: 3, type: 'spell', art: '🐺', text: '所有随从+2/+2', effect: 'buff_all_2_2' , rarity: 'epic'},
  ...
  // --- Class System Cards (Iter 26) ---
  { id: 'hun_alpha_king', name: '兽群之王', cost: 6, type: 'minion', attack: 6, hp: 6, art: '🦁', text: '野兽·战吼：使所有友方野兽+2/+2', battlecry: 'buff_beasts_2_2', race: 'beast', rarity: 'epic'},
  { id: 'hun_stampede', name: '兽潮奔袭', cost: 4, type: 'spell', art: '🐎', text: '召唤两个3/3野兽', effect: 'summon_two_3_3', rarity: 'epic'},
  { id: 'hun_trap_master', name: '陷阱大师', cost: 4, type: 'minion', attack: 4, hp: 4, art: '🪤', text: '战吼：对所有敌方随从造成2点伤害', battlecry: 'deal_2_all', rarity: 'rare'},
  { id: 'mage_sorcerer_2', name: '秘法学者', cost: 4, type: 'minion', attack: 3, hp: 5, art: '📖', text: '法术伤害+1', spellDamage: 1, rarity: 'rare'},
  { id: 'mage_epic_combustion', name: '燃烧', cost: 3, type: 'spell', art: '🔥', text: '造成6点伤害', effect: 'deal_6_face', rarity: 'epic'},
  { id: 'mage_arcane_echo', name: '奥术回响', cost: 4, type: 'spell', art: '🔊', text: '造成3点伤害，抽1张牌', effect: 'deal_3_draw_1', rarity: 'rare'},
  { id: 'pri_shadow_word_death', name: '暗言术·灭', cost: 3, type: 'spell', art: '💀', text: '消灭一个敌方随从', effect: 'assassinate', rarity: 'epic'},
  { id: 'pri_epic_power_infusion', name: '神圣灌注', cost: 2, type: 'spell', art: '✨', text: '使所有友方随从+1/+1', effect: 'buff_all_1_1', rarity: 'rare'},
  ...
  // --- Neutral Legendaries (Iter 34) ---
  { id: 'neu_epic_ancient_dragon', name: '远古巨龙', cost: 7, type: 'minion', attack: 8, hp: 8, art: '🐉', text: '战吼：对所有敌方随从造成3点伤害', battlecry: 'deal_3_all', rarity: 'legendary'},
  { id: 'neu_epic_time_lord', name: '时间主宰', cost: 6, type: 'minion', attack: 4, hp: 6, art: '⏳', text: '战吼：抽2张牌', battlecry: 'draw_2', rarity: 'legendary'},
  { id: 'neu_epic_void_queen', name: '虚空女王', cost: 8, type: 'minion', attack: 6, hp: 8, art: '🌑', text: '嘲讽·战吼：获得8点护甲', taunt: true, battlecry: 'gain_armor_8', rarity: 'legendary'},
...
const CLASSES = {
  mage: {
    ...
    'mage_sorcerer_2',
    'mage_epic_combustion',
    'mage_arcane_echo',
    'neu_epic_ancient_dragon',
    'neu_epic_time_lord',
    'neu_epic_void_queen',
    'neu_epic_storm_avatar',
    'neu_epic_judgment_angel',
    'neu_epic_world_tree'],
...
const ENEMIES = {
  ...
  boss: [
    { name: '森林之王·古树', portrait: '🌳', hp: 80, deck: ['stone_golem','war_golem','shield_bearer','giant','undead_knight','healer','paladin_knight','summoner','ogre','flamestrike','consecration','cultist','ragnaros','guardsman'], ai: 'control', isBoss: true, act: 1, rewardRelic: true, enrage: { summons: [{ name: '古树守卫', attack: 4, hp: 4, art: '🌳', taunt: true }] }, phases: [{ hpRatio: 0.35, onEnter: 'buff', skill: 'summon', every: 4 }] },
    { name: '暗影领主', portrait: '🦇', hp: 95, deck: ['sylvanas','mind_control','assassinate','undead_knight','cultist','summoner','mirror_entity','deathwing','loot_hoarder','flamestrike','blizzard','equality','doom_blade','ragnaros'], ai: 'control', isBoss: true, act: 2, rewardRelic: true, enrage: { buff: 3 }, phases: [{ hpRatio: 0.4, onEnter: 'clear_armor', skill: 'aoe', every: 3 }, { hpRatio: 0.2, onEnter: 'weaken', skill: 'aoe', every: 2 }] },
    { name: '裂境之主·虚空', portrait: '👁️', hp: 128, deck: ['ragnaros','deathwing','sylvanas','undead_knight','giant','dragon','pyroblast','mind_control','flamestrike','equality','assassinate','blizzard','doom_blade','water_elemental','faceless'], ai: 'boss', isBoss: true, act: 3, rewardRelic: true, enrage: { summons: [{ name: '虚空行者', attack: 5, hp: 5, art: '👁️' }], buff: 1 }, phases: [{ hpRatio: 0.4, onEnter: 'mana_burn', skill: 'summon', every: 2 }, { hpRatio: 0.2, onEnter: 'weaken', skill: 'summon', every: 2 }] },
    { name: '星界吞噬者', portrait: '🌌', hp: 155, deck: ['deathwing','ragnaros','sylvanas','pyroblast','mind_control','flamestrike','blizzard','equality','assassinate','doom_blade','giant','dragon','faceless','archmage','fireball'], ai: 'boss', isBoss: true, act: 4, rewardRelic: true, enrage: { summons: [{ name: '星界触须', attack: 6, hp: 6, art: '🌌' }], buff: 2 }, phases: [{ hpRatio: 0.4, onEnter: 'aoe', skill: 'heal', every: 3 }, { hpRatio: 0.2, onEnter: 'summon', skill: 'aoe', every: 2 }] },
...
const CHALLENGE_MODS = [
  { id: 'challenge_wounds', name: '伤痕累累', icon: '🩸', desc: '敌人生命+15%、攻击+15%', shardBonus: 0.4 },
