...
const TUTORIAL_STEPS = [
  ...
  { icon: '🧭', title: '检索（新机制）', text: '带有"检索"效果的法术会从你的牌库中定向抽取指定类型的牌（如随从、法术、野兽、低费牌等）直接加入手牌。检索是构筑关键卡组的核心手段，务必善用牌库！' },
  { icon: '🐾', title: '种族体系（新机制）', text: '卡牌带有种族标签：野兽、元素、机械、龙、鱼人、恶魔。同种族卡牌之间存在协同效果（如"你的野兽+1/+1"）。收集同种族卡牌能打出强大的体系combo！' },
  { icon: '🎮', title: '游戏模式', text: '· 标准模式：经典3幕通关  · 无限模式：第3幕后无尽轮回，敌人每幕+18%生命/+12%攻击，可无限刷取碎晶  · 极速模式：单幕快节奏，初始+20%生命和25金币，适合速通' },
  { icon: '🎓', title: '教学关', text: '首次冒险会先进入2个教学战斗，跟着引导横幅学习打牌、随从、英雄技能和法术的用法。教学完成后将使用你的完整卡组正式冒险！' },
  { icon: '🏆', title: '局外成长（裂境碎晶）', text: '击败首领、通关或挑战失败都会获得💎裂境碎晶。在主菜单点击"裂境强化"可以永久升级：初始生命、初始金币、稀有奖励概率等，让每一次冒险都更强！' },
  { icon: '❓', title: '卡牌类型与稀有度', text: '· 随从：召唤上场，下回合可攻击 · 法术：立即生效，可分为伤害/治疗/增益/检索等 · 武器：装备后英雄可攻击，有耐久度 · 稀有度：普通→稀有→史诗→传说，越稀有通常越强力，奖励选择中传说卡出现率较低' },
  { icon: '⚡', title: '战斗小贴士', text: '· 关注敌方意图（攻击/防御/技能）提前规划 · 嘲讽随从保护英雄，潜行随从不会被打 · 圣盾抵挡一次伤害，风怒可攻击两次，剧毒秒杀被击中的随从 · 冲锋随从当回合即可攻击 · 手牌最多10张，抽牌溢出会弃置' },
];
